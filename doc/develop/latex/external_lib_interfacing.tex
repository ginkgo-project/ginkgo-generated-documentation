The external library(deal.\+II) interfacing example..
 ...
 \label{_external_lib_interfacing_Intro}%
 \label{_external_lib_interfacing_Introduction}%
\doxysection*{Introduction}

\label{_external_lib_interfacing_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_external_lib_interfacing_CommProg}%
...
\label{_external_lib_interfacing_AdvectionProblemclassdeclaration}%
...
\label{_external_lib_interfacing_Equationdatadeclaration}%
...
\label{_external_lib_interfacing_GradientEstimationclassdeclaration}%
...
\label{_external_lib_interfacing_AdvectionProblemclassimplementation}%
...
\begin{DoxyCode}{0}
\DoxyCodeLine{std::vector<double> \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}(num\_rows);}
\DoxyCodeLine{std::copy(system\_rhs.begin(), system\_rhs.begin() + num\_rows, \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}.begin());}
\end{DoxyCode}
...
\DoxyCodeLine{                     val\_array::view(exec, num\_rows, \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}.data()), 1);}
...
\DoxyCodeLine{            gko::stop::Iteration::build().with\_max\_iters(1000),}
\DoxyCodeLine{            \mbox{\hyperlink{classgko_1_1stop_1_1ResidualNorm}{gko::stop::ResidualNorm<>::build}}().with\_reduction\_factor(1e-\/12))}
\DoxyCodeLine{        .with\_preconditioner(bj::build())}
\DoxyCodeLine{        .on(exec);}
\DoxyCodeLine{\textcolor{keyword}{auto} \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a7cbf673200498a0d1324f4330825202a}{solver}} = solver\_gen-\/>generate(\mbox{\hyperlink{namespacegko_acbd3fd6d07e498892881e8e2ab0b4167}{gko::give}}(A));}
\end{DoxyCode}
...
\DoxyCodeLine{}
\DoxyCodeLine{/ ******************************************************}
\DoxyCodeLine{ * deal.ii \textcolor{keyword}{internal} \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a7cbf673200498a0d1324f4330825202a}{solver}}. Here \textcolor{keywordflow}{for} reference.}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} cycle = 0; \mbox{\hyperlink{namespacegko_1_1solver_1_1multigrid_a4f89fc8a003f879d4ff2f482c2fbab68}{cycle}} < 6; ++\mbox{\hyperlink{namespacegko_1_1solver_1_1multigrid_a4f89fc8a003f879d4ff2f482c2fbab68}{cycle}}) \{}
\DoxyCodeLine{        std::cout << \textcolor{stringliteral}{"Cycle "} << \mbox{\hyperlink{namespacegko_1_1solver_1_1multigrid_a4f89fc8a003f879d4ff2f482c2fbab68}{cycle}} << \textcolor{charliteral}{':'} << std::endl;}
\DoxyCodeLine{}
...
\label{_external_lib_interfacing_GradientEstimationclassimplementation}%
...
If we are not in 1d, we collect all neighbor children \char`\"{}behind\char`\"{} the subfaces of the current face
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_external_lib_interfacing_Results}%
\doxysection*{Results}

\label{_external_lib_interfacing_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_external_lib_interfacing_PlainProg}%
