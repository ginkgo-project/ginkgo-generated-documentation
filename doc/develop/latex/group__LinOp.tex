...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{group__LinOp}
\end{center}
\end{figure}
\doxysubsection*{Modules}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{group__distributed}{Distributed}}
\begin{DoxyCompactList}\small\item\em A module dedicated to the implementation and usage of the distributed linear algebra objects in Ginkgo. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{group__reorder}{Reordering Algorithms}}
\begin{DoxyCompactList}\small\item\em A module dedicated to the implementation and usage of the reordering algorithms in Ginkgo. \end{DoxyCompactList}\item 
...
class \mbox{\hyperlink{classgko_1_1experimental_1_1distributed_1_1preconditioner_1_1Schwarz}{gko\+::experimental\+::distributed\+::preconditioner\+::\+Schwarz$<$ Value\+Type, Local\+Index\+Type, Global\+Index\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ic}{gko\+::preconditioner\+::\+Ic$<$ Value\+Type, Index\+Type $>$}}
\begin{DoxyCompactList}\small\item\em The Incomplete Cholesky (IC) preconditioner solves the equation $L L^H x = b$ for a given lower triangular matrix $L$ and the right hand side $b$ (can contain multiple right hand sides). \end{DoxyCompactList}\item 
class \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko\+::preconditioner\+::\+Ilu$<$ Value\+Type, Reverse\+Apply, Index\+Type $>$}}
...
\begin{DoxyCompactList}\small\item\em The Incomplete Sparse Approximate Inverse (I\+S\+AI) Preconditioner generates an approximate inverse matrix for a given square matrix $A$, lower triangular matrix $L$, upper triangular matrix $U$ or symmetric positive definite (s.\+p.\+d) matrix $B$. \end{DoxyCompactList}\item 
...
class \mbox{\hyperlink{classgko_1_1solver_1_1Chebyshev}{gko\+::solver\+::\+Chebyshev$<$ Value\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1Gcr}{gko\+::solver\+::\+Gcr$<$ Value\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1Minres}{gko\+::solver\+::\+Minres$<$ Value\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1PipeCg}{gko\+::solver\+::\+Pipe\+Cg$<$ Value\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1EnableSolverBase}{gko\+::solver\+::\+Enable\+Solver\+Base$<$ Derived\+Type, Matrix\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1IterativeBase}{gko\+::solver\+::\+Iterative\+Base}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1EnableIterativeBase}{gko\+::solver\+::\+Enable\+Iterative\+Base$<$ Derived\+Type $>$}}
...
class \mbox{\hyperlink{classgko_1_1solver_1_1EnablePreconditionedIterativeSolver}{gko\+::solver\+::\+Enable\+Preconditioned\+Iterative\+Solver$<$ Value\+Type, Derived\+Type $>$}}
...
\begin{DoxyCompactList}\small\item\em Creates a vector factory parameter in the factory parameters structure. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename Matrix , typename... T\+Args$>$ }\\std\+::unique\+\_\+ptr$<$ Matrix $>$ \mbox{\hyperlink{group__LinOp_ga2f54bac1e95fb3ef03974fa9c9088491}{gko\+::initialize}} (\mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{size\+\_\+type}} stride, std\+::initializer\+\_\+list$<$ typename Matrix\+::value\+\_\+type $>$ vals, std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ exec, T\+Args \&\&... create\+\_\+args)
\begin{DoxyCompactList}\small\item\em Creates and initializes a column-\/vector. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Matrix , typename... T\+Args$>$ }\\std\+::unique\+\_\+ptr$<$ Matrix $>$ \mbox{\hyperlink{group__LinOp_gaac5f7b4ff3b43dbc6918c687dd7d2d2e}{gko\+::initialize}} (std\+::initializer\+\_\+list$<$ typename Matrix\+::value\+\_\+type $>$ vals, std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ exec, T\+Args \&\&... create\+\_\+args)
\begin{DoxyCompactList}\small\item\em Creates and initializes a column-\/vector. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Matrix , typename... T\+Args$>$ }\\std\+::unique\+\_\+ptr$<$ Matrix $>$ \mbox{\hyperlink{group__LinOp_gaaf2520e5921e1bea00853c290f4fc28f}{gko\+::initialize}} (\mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{size\+\_\+type}} stride, std\+::initializer\+\_\+list$<$ std\+::initializer\+\_\+list$<$ typename Matrix\+::value\+\_\+type $>$$>$ vals, std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ exec, T\+Args \&\&... create\+\_\+args)
...
\DoxyCodeLine{\{}
\DoxyCodeLine{    \textcolor{keyword}{auto} x = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(x0);}
\DoxyCodeLine{    \textcolor{keyword}{auto} tmp = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(x0);}
...
\DoxyCodeLine{        L-\/>apply(tmp, x);}
\DoxyCodeLine{        x-\/>add\_scaled(\mbox{\hyperlink{namespacegko_a0059e27f8f4bc348ff65c1e60caf47c8}{one}}, b);}
\DoxyCodeLine{        tmp-\/>copy\_from(x);}
\DoxyCodeLine{    \}}
...
Here, if $L$ is a matrix, \mbox{\hyperlink{classgko_1_1LinOp_af9979dfd1401bd219b02caaaa445b893}{Lin\+Op\+::apply()}} refers to the matrix vector product, and {\ttfamily L-\/$>$apply(a, b)} computes $b = L \cdot a$. {\ttfamily x-\/$>$add\+\_\+scaled(one, b)} is the {\ttfamily axpy} vector update $x:=x+b$.

The interesting part of this example is the apply() routine at line 5 of the function body. Since this routine is part of the \mbox{\hyperlink{classgko_1_1LinOp}{Lin\+Op}} base class, the fixed-\/point iteration routine can calculate a fixed point not only for matrices, but for any type of linear operator.
...
\`{}\`{}\`{}c++ struct My\+Lin\+Op \+: public Lin\+Op \{ \mbox{\hyperlink{group__LinOp_ga8e0af90ec2414b768266f77cedffc309}{G\+K\+O\+\_\+\+E\+N\+A\+B\+L\+E\+\_\+\+L\+I\+N\+\_\+\+O\+P\+\_\+\+F\+A\+C\+T\+O\+R\+Y(\+My\+Lin\+Op, my\+\_\+parameters, Factory)}} \{ // a factory parameter named \char`\"{}my\+\_\+value\char`\"{}, of type int and default // value of 5 int \mbox{\hyperlink{group__LinOp_ga49d4c09c39f06b22bebbbfd1d8bfe450}{G\+K\+O\+\_\+\+F\+A\+C\+T\+O\+R\+Y\+\_\+\+P\+A\+R\+A\+M\+E\+T\+E\+R\+\_\+\+S\+C\+A\+L\+A\+R(my\+\_\+value, 5)}}; // a factory parameter named {\ttfamily my\+\_\+pair} of type {\ttfamily std\+::pair$<$int,int$>$} // and default value \{5, 5\} std\+::pair$<$int, int$>$ \mbox{\hyperlink{group__LinOp_gaa292314d27ec1fb7ad54debaa3606ea8}{G\+K\+O\+\_\+\+F\+A\+C\+T\+O\+R\+Y\+\_\+\+P\+A\+R\+A\+M\+E\+T\+E\+R\+\_\+\+V\+E\+C\+T\+O\+R(my\+\_\+pair, 5, 5)}}; \}; // constructor needed by Lin\+Op explicit My\+Lin\+Op(std\+::shared\+\_\+ptr$<$const Executor$>$ exec) \{ \+: Lin\+Op(exec) \{\} // constructor needed by the factory explicit My\+Lin\+Op(const Factory $\ast$factory, std\+::shared\+\_\+ptr$<$const Lin\+Op$>$ matrix) \+: Lin\+Op(factory-\/$>$get\+\_\+executor()), matrix-\/$>$get\+\_\+size()), // store factory\textquotesingle{}s parameters locally my\+\_\+parameters\+\_\+\{factory-\/$>$get\+\_\+parameters()\}, \{ int value = my\+\_\+parameters\+\_\+.\+my\+\_\+value; // do something with value \} 
\begin{DoxyCode}{0}
\DoxyCodeLine{MyLinOp can then be created \mbox{\hyperlink{namespacegko_a618c9b64c35b0452240e9e57a9673b94}{as}} follows:}
\DoxyCodeLine{}
\DoxyCodeLine{```c++}
...
\DoxyCodeLine{\textcolor{keyword}{auto} my\_op = fact-\/>generate(\mbox{\hyperlink{classgko_1_1matrix_1_1Identity_ac8f28ec7da5e01316836ab945725896c}{gko::matrix::Identity::create}}(exec, 2));}
...
\mbox{\Hypertarget{group__LinOp_gaaf2520e5921e1bea00853c290f4fc28f}\label{group__LinOp_gaaf2520e5921e1bea00853c290f4fc28f}} 
\index{Linear Operators@{Linear Operators}!initialize@{initialize}}
\index{initialize@{initialize}!Linear Operators@{Linear Operators}}
...
\mbox{\Hypertarget{group__LinOp_ga2f54bac1e95fb3ef03974fa9c9088491}\label{group__LinOp_ga2f54bac1e95fb3ef03974fa9c9088491}} 
\index{Linear Operators@{Linear Operators}!initialize@{initialize}}
\index{initialize@{initialize}!Linear Operators@{Linear Operators}}
...
\mbox{\Hypertarget{group__LinOp_gabe4ff67be5b3aae4e981b33ea9883385}\label{group__LinOp_gabe4ff67be5b3aae4e981b33ea9883385}} 
\index{Linear Operators@{Linear Operators}!initialize@{initialize}}
\index{initialize@{initialize}!Linear Operators@{Linear Operators}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{group__LinOp_gaac5f7b4ff3b43dbc6918c687dd7d2d2e}\label{group__LinOp_gaac5f7b4ff3b43dbc6918c687dd7d2d2e}} 
\index{Linear Operators@{Linear Operators}!initialize@{initialize}}
\index{initialize@{initialize}!Linear Operators@{Linear Operators}}
