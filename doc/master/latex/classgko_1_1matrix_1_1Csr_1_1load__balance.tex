...
\end{DoxyParams}
\begin{DoxyNote}{Note}
T\+O\+DO\+: porting -\/ we hardcode the subgroup size is 32 
\end{DoxyNote}
...
References gko\+::ceildiv(), gko\+::array$<$ Value\+Type $>$\+::get\+\_\+const\+\_\+data(), gko\+::array$<$ Value\+Type $>$\+::get\+\_\+data(), gko\+::array$<$ Value\+Type $>$\+::get\+\_\+executor(), and gko\+::array$<$ Value\+Type $>$\+::get\+\_\+size().
