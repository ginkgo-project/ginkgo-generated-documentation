...
\begin{DoxyCode}{0}
\DoxyCodeLine{The \textcolor{keyword}{function} `f` is set to `f(x) = 6x` (making the solution `u(x) = x\string^3`), but}
\DoxyCodeLine{that can be changed in the `main` \textcolor{keyword}{function}.}
\DoxyCodeLine{}
\DoxyCodeLine{The intention of the example is to show how Ginkgo can be integrated into}
\DoxyCodeLine{existing software -\/ the `generate\_stencil\_matrix`, `generate\_rhs`,}
\DoxyCodeLine{`print\_solution`, `compute\_error` and `main` \textcolor{keyword}{function} \textcolor{keywordflow}{do} not reference Ginkgo at}
\DoxyCodeLine{all (i.e. they could have been there before the application developer decided to}
\DoxyCodeLine{use Ginkgo, and the only part where Ginkgo is introduced is inside the}
\DoxyCodeLine{`solve\_system` \textcolor{keyword}{function}.}
...
\DoxyCodeLine{        \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}[i] = -\/f(xi) * h * h;}
\DoxyCodeLine{    \}}
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}[0] += u0;}
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}[discretization\_points -\/ 1] += u1;}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} Closure, \textcolor{keyword}{typename} ValueType, \textcolor{keyword}{typename} IndexType>}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_afd46d554050c4ae90e84ea4fcd9a41f3}{gko::remove\_complex<ValueType>}} calculate\_error(IndexType discretization\_points,}
\DoxyCodeLine{                                               \textcolor{keyword}{const} ValueType* u,}
...
\DoxyCodeLine{        \textcolor{keyword}{const} ValueType xi = ValueType(i + 1) * h;}
\DoxyCodeLine{        error += \mbox{\hyperlink{namespacegko_adeb470aaf293d7c5548392b2f451e8e4}{abs}}(u[i] -\/ correct\_u(xi)) / \mbox{\hyperlink{namespacegko_adeb470aaf293d7c5548392b2f451e8e4}{abs}}(correct\_u(xi));}
\DoxyCodeLine{    \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keyword}{auto} app\_exec = exec-\/>\mbox{\hyperlink{classgko_1_1Executor_acaec4f999d52fc71e5e5a3d3ad93609c}{get\_master}}();}
\end{DoxyCode}
...
\DoxyCodeLine{        .with\_criteria(gko::stop::Iteration::build().with\_max\_iters(}
\DoxyCodeLine{                           \mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{gko::size\_type}}(dp)),}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{std::vector<ValueType> \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}(discretization\_points);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{generate\_rhs(discretization\_points, f, u0, u1, \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}.data());}
\DoxyCodeLine{}
\DoxyCodeLine{solve\_system(executor\_string, discretization\_points, row\_ptrs.data(),}
\DoxyCodeLine{             col\_idxs.data(), values.data(), \mbox{\hyperlink{namespacegko_1_1solver_a82d21321745fbd3dc65c276d5838bb8aa83ff9f9e3dd7561d3dd91204cf546b7e}{rhs}}.data(), u.data(),}
\DoxyCodeLine{             reduction\_factor);}
\end{DoxyCode}


Uncomment to print the solution print\+\_\+solution$<$\+Value\+Type, Index\+Type$>$(discretization\+\_\+points, 0, 1, u.\+data());
