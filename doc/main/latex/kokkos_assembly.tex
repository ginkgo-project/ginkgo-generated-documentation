...
If this example is built as part of Ginkgo, it is advised to configure Ginkgo with {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+W\+I\+T\+H\+\_\+\+C\+C\+A\+C\+HE=O\+FF} to prevent incompabilities with Kokkos\textquotesingle{} compiler wrapper for {\ttfamily nvcc}. \label{_CommProg}%
