...
This example depends on preconditioned-\/solver.
 ...
 \label{_adaptiveprecision_blockjacobi_Intro}%
...
\label{_adaptiveprecision_blockjacobi_CommProg}%
...
\DoxyCodeLine{\}}
\DoxyCodeLine{\textcolor{keyword}{auto} x = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(exec, host\_x);}
\DoxyCodeLine{\textcolor{keyword}{auto} b = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(exec, host\_x);}
\end{DoxyCode}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, impl\_res);}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_adaptiveprecision_blockjacobi_Results}%
\doxysection*{Results}
...
\label{_adaptiveprecision_blockjacobi_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_adaptiveprecision_blockjacobi_PlainProg}%
