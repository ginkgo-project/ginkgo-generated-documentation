...
\begin{DoxyCode}{0}
\DoxyCodeLine{Kokkos::View<IndexType*> v\_row\_idxs(md.get\_row\_idxs(),}
\DoxyCodeLine{                                    md.get\_num\_stored\_elements());}
\DoxyCodeLine{Kokkos::View<IndexType*> v\_col\_idxs(md.get\_col\_idxs(),}
\DoxyCodeLine{                                    md.get\_num\_stored\_elements());}
\DoxyCodeLine{Kokkos::View<ValueType*> v\_values(md.get\_values(),}
\DoxyCodeLine{                                  md.get\_num\_stored\_elements());}
\end{DoxyCode}
...
\DoxyCodeLine{            lsum += Kokkos::abs((v\_u(i) -\/ correct\_u(xi)) /}
...
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#if KOKKOS\_VERSION / 10000 < 4}}
\DoxyCodeLine{\textcolor{keyword}{namespace }Kokkos \{}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{using} Experimental::abs;}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\}}
\DoxyCodeLine{\textcolor{preprocessor}{\#endif}}
