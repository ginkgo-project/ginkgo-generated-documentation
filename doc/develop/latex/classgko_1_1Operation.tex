...
Inheritance diagram for gko\+::Operation\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=254pt]{classgko_1_1Operation__inherit__graph}
\end{center}
\end{figure}
...
\item 
\mbox{\Hypertarget{classgko_1_1Operation_aedeae9ad780ef795586b28bc465cea1c}\label{classgko_1_1Operation_aedeae9ad780ef795586b28bc465cea1c}} 
virtual void {\bfseries run} (std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1DpcppExecutor}{Dpcpp\+Executor}} $>$) const
\item 
...
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keywordtype}{void} run(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1DpcppExecutor}{gko::DpcppExecutor}} *exec)\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{    }\{ os\_ << \textcolor{stringliteral}{"DPC++("} << exec-\/>\mbox{\hyperlink{classgko_1_1DpcppExecutor_aefdd7095f2d18ff8e4ab8354006f305b}{get\_device\_id}}() << \textcolor{stringliteral}{")"}; \}}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} omp = \mbox{\hyperlink{classgko_1_1OmpExecutor_a8930142a1913bcbcac4fb6c917f930d9}{gko::OmpExecutor::create}}();}
\DoxyCodeLine{std::cout << *omp << std::endl}
\DoxyCodeLine{          << *\mbox{\hyperlink{classgko_1_1CudaExecutor_a6c423656c7c0eb53810cb77bb4a66d15}{gko::CudaExecutor::create}}(0, omp) << std::endl}
\DoxyCodeLine{          << *\mbox{\hyperlink{classgko_1_1HipExecutor_aa0701fe1303e03a8331da7e95008100d}{gko::HipExecutor::create}}(0, omp) << std::endl}
\DoxyCodeLine{          << *\mbox{\hyperlink{classgko_1_1DpcppExecutor_ae9b875dfe3af7f3f3f24071bfb2f895e}{gko::DpcppExecutor::create}}(0, omp) << std::endl}
...
One might feel that this code is too complicated for such a simple task. Luckily, there is an overload of the \mbox{\hyperlink{classgko_1_1Executor_a1de8e2668b76e66690acf5eef9e8324d}{Executor\+::run()}} method, which is designed to facilitate writing simple operations like this one. The method takes four closures as input\+: one which is run for O\+MP, one for C\+U\+DA executors, one for H\+IP executors, and the last one for D\+P\+C++ executors. Using this method, there is no need to implement an \mbox{\hyperlink{classgko_1_1Operation}{Operation}} subclass\+:
...
\DoxyCodeLine{                        .get\_device\_id()}
\DoxyCodeLine{                   << \textcolor{stringliteral}{")"}; \});}
\DoxyCodeLine{        [\&]() \{ os << \textcolor{stringliteral}{"DPC++("}    \textcolor{comment}{// DPC++ closure}}
\DoxyCodeLine{                   << static\_cast<gko::DpcppExecutor\&>(exec)}
\DoxyCodeLine{                        .get\_device\_id()}
\DoxyCodeLine{                   << \textcolor{stringliteral}{")"}; \});}
\DoxyCodeLine{    \textcolor{keywordflow}{return} os;}
\DoxyCodeLine{\}}
