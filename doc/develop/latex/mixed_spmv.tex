The mixed spmv example..
 ...
 \label{_mixed_spmv_Intro}%
 \label{_mixed_spmv_Introduction}%
...
\label{_mixed_spmv_Abouttheexample}%
...
\end{DoxyEnumerate}\label{_mixed_spmv_CommProg}%
 \doxysection*{The commented program}

\label{_mixed_spmv_Includefiles}%
...
\DoxyCodeLine{ * /}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} ValueTypeIn, \textcolor{keyword}{typename} ValueTypeOut>}
...
\DoxyCodeLine{              std::shared\_ptr<\mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<ValueTypeIn>}}> b,}
\DoxyCodeLine{              std::shared\_ptr<\mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<ValueTypeOut>}}> x)}
\DoxyCodeLine{\{}
...
\label{_mixed_spmv_Wheredoyouwanttorunyouroperation}%
...
\label{_mixed_spmv_Preparingyourdataandtransfertotheproperdevice}%
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} hp\_b = \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{share}}(\mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(exec, host\_b));}
...
\label{_mixed_spmv_Measurethetimeofapply}%
...
\label{_mixed_spmv_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_mixed_spmv_PlainProg}%
