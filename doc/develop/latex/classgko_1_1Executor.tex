...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classgko_1_1Executor__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classgko_1_1Executor__coll__graph}
\end{center}
\end{figure}
...
\item 
\mbox{\Hypertarget{classgko_1_1Executor_ad9770f8bb4b67e9d9e7eb32a62253061}\label{classgko_1_1Executor_ad9770f8bb4b67e9d9e7eb32a62253061}} 
{\bfseries Executor} (\mbox{\hyperlink{classgko_1_1Executor}{Executor}} \&\&)=delete
\item 
...
\item 
\mbox{\Hypertarget{classgko_1_1Executor_a8493acf76ff3ff50d01937972ff8e5b9}\label{classgko_1_1Executor_a8493acf76ff3ff50d01937972ff8e5b9}} 
\mbox{\hyperlink{classgko_1_1Executor}{Executor}} \& {\bfseries operator=} (\mbox{\hyperlink{classgko_1_1Executor}{Executor}} \&\&)=delete
\item 
...
{\footnotesize template$<$typename Closure\+Reference , typename Closure\+Omp , typename Closure\+Cuda , typename Closure\+Hip , typename Closure\+Dpcpp $>$ }\\void \mbox{\hyperlink{classgko_1_1Executor_abe906f109824da54447e504ff88aa97f}{run}} (std\+::string name, const Closure\+Reference \&op\+\_\+ref, const Closure\+Omp \&op\+\_\+omp, const Closure\+Cuda \&op\+\_\+cuda, const Closure\+Hip \&op\+\_\+hip, const Closure\+Dpcpp \&op\+\_\+dpcpp) const
\begin{DoxyCompactList}\small\item\em Runs one of the passed in functors, depending on the \mbox{\hyperlink{classgko_1_1Executor}{Executor}} type. \end{DoxyCompactList}\item 
...
{\footnotesize template$<$typename T $>$ }\\void \mbox{\hyperlink{classgko_1_1Executor_a8050a118e6ac312a768ec56d3d3aae20}{copy\+\_\+from}} (\mbox{\hyperlink{classgko_1_1ptr__param}{ptr\+\_\+param}}$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ src\+\_\+exec, \mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{size\+\_\+type}} num\+\_\+elems, const T $\ast$src\+\_\+ptr, T $\ast$dest\+\_\+ptr) const
...
void \mbox{\hyperlink{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}{add\+\_\+logger}} (std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1log_1_1Logger}{log\+::\+Logger}} $>$ logger) override
\item 
void \mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\+\_\+logger}} (const \mbox{\hyperlink{classgko_1_1log_1_1Logger}{log\+::\+Logger}} $\ast$logger) override
\item 
void \mbox{\hyperlink{classgko_1_1Executor_a8801d54a4ac842def0b88d643b37b1db}{set\+\_\+log\+\_\+propagation\+\_\+mode}} (\mbox{\hyperlink{namespacegko_aa2543f42cbbe1a9373dc46d04c112bee}{log\+\_\+propagation\+\_\+mode}} mode)
\begin{DoxyCompactList}\small\item\em Sets the logger event propagation mode for the executor. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classgko_1_1Executor_a3d59329aa9e2db037f2ebb6748bf4a5b}{should\+\_\+propagate\+\_\+log}} () const
\begin{DoxyCompactList}\small\item\em Returns true iff events occurring at an object created on this executor should be logged at propagating loggers attached to this executor, and there is at least one such propagating logger. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Verifies whether the executors share the same memory. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{classgko_1_1Executor_aa669b06a924ce594bfc44cbbbfd633b4}\label{classgko_1_1Executor_aa669b06a924ce594bfc44cbbbfd633b4}} 
virtual \mbox{\hyperlink{classgko_1_1scoped__device__id__guard}{scoped\+\_\+device\+\_\+id\+\_\+guard}} {\bfseries get\+\_\+scoped\+\_\+device\+\_\+id\+\_\+guard} () const =0
\item 
virtual std\+::string \mbox{\hyperlink{classgko_1_1Executor_a9b25713dfacc7914b69115f815e616b0}{get\+\_\+description}} () const =0
...
\mbox{\Hypertarget{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}\label{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}} 
\index{gko::Executor@{gko::Executor}!add\_logger@{add\_logger}}
\index{add\_logger@{add\_logger}!gko::Executor@{gko::Executor}}
\doxysubsubsection{\texorpdfstring{add\_logger()}{add\_logger()}}
{\footnotesize\ttfamily void gko\+::\+Executor\+::add\+\_\+logger (\begin{DoxyParamCaption}\item[{std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1log_1_1Logger}{log\+::\+Logger}} $>$}]{logger }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
\mbox{\Hypertarget{classgko_1_1Executor_a8050a118e6ac312a768ec56d3d3aae20}\label{classgko_1_1Executor_a8050a118e6ac312a768ec56d3d3aae20}} 
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
void gko\+::\+Executor\+::copy\+\_\+from (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classgko_1_1ptr__param}{ptr\+\_\+param}}$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$}]{src\+\_\+exec,  }\item[{\mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{size\+\_\+type}}}]{num\+\_\+elems,  }\item[{const T $\ast$}]{src\+\_\+ptr,  }\item[{T $\ast$}]{dest\+\_\+ptr }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classgko_1_1Executor_a9b25713dfacc7914b69115f815e616b0}\label{classgko_1_1Executor_a9b25713dfacc7914b69115f815e616b0}} 
\index{gko::Executor@{gko::Executor}!get\_description@{get\_description}}
\index{get\_description@{get\_description}!gko::Executor@{gko::Executor}}
\doxysubsubsection{\texorpdfstring{get\_description()}{get\_description()}}
{\footnotesize\ttfamily virtual std\+::string gko\+::\+Executor\+::get\+\_\+description (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [pure virtual]}}
...
Implemented in \mbox{\hyperlink{classgko_1_1DpcppExecutor_a30330475d4668e72586456434171b6d6}{gko\+::\+Dpcpp\+Executor}}, \mbox{\hyperlink{classgko_1_1HipExecutor_a205464163af208922487c35a6d198418}{gko\+::\+Hip\+Executor}}, \mbox{\hyperlink{classgko_1_1CudaExecutor_ac429a47e4fab2f11df0dd09fc9652a19}{gko\+::\+Cuda\+Executor}}, \mbox{\hyperlink{classgko_1_1ReferenceExecutor_a84e5353b33e9d648476aed0e76999358}{gko\+::\+Reference\+Executor}}, and \mbox{\hyperlink{classgko_1_1OmpExecutor_a157fbc623333a1658f8a3915e7b2da2d}{gko\+::\+Omp\+Executor}}.
...
Referenced by copy\+\_\+val\+\_\+to\+\_\+host().
...
\end{DoxyReturn}
\mbox{\Hypertarget{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}\label{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}} 
\index{gko::Executor@{gko::Executor}!remove\_logger@{remove\_logger}}
\index{remove\_logger@{remove\_logger}!gko::Executor@{gko::Executor}}
\doxysubsubsection{\texorpdfstring{remove\_logger()}{remove\_logger()}}
{\footnotesize\ttfamily void gko\+::\+Executor\+::remove\+\_\+logger (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classgko_1_1log_1_1Logger}{log\+::\+Logger}} $\ast$}]{logger }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
References gko\+::log\+::\+Logger\+::needs\+\_\+propagation().
...
Implemented in \mbox{\hyperlink{classgko_1_1ReferenceExecutor_a82b41b42dbd26e8ac5b0146de79e5d34}{gko\+::\+Reference\+Executor}}.



Referenced by run().

\mbox{\Hypertarget{classgko_1_1Executor_abe906f109824da54447e504ff88aa97f}\label{classgko_1_1Executor_abe906f109824da54447e504ff88aa97f}} 
\index{gko::Executor@{gko::Executor}!run@{run}}
\index{run@{run}!gko::Executor@{gko::Executor}}
...
void gko\+::\+Executor\+::run (\begin{DoxyParamCaption}\item[{std\+::string}]{name,  }\item[{const Closure\+Reference \&}]{op\+\_\+ref,  }\item[{const Closure\+Omp \&}]{op\+\_\+omp,  }\item[{const Closure\+Cuda \&}]{op\+\_\+cuda,  }\item[{const Closure\+Hip \&}]{op\+\_\+hip,  }\item[{const Closure\+Dpcpp \&}]{op\+\_\+dpcpp }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\mbox{\Hypertarget{classgko_1_1Executor_a8801d54a4ac842def0b88d643b37b1db}\label{classgko_1_1Executor_a8801d54a4ac842def0b88d643b37b1db}} 
\index{gko::Executor@{gko::Executor}!set\_log\_propagation\_mode@{set\_log\_propagation\_mode}}
\index{set\_log\_propagation\_mode@{set\_log\_propagation\_mode}!gko::Executor@{gko::Executor}}
\doxysubsubsection{\texorpdfstring{set\_log\_propagation\_mode()}{set\_log\_propagation\_mode()}}
{\footnotesize\ttfamily void gko\+::\+Executor\+::set\+\_\+log\+\_\+propagation\+\_\+mode (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{namespacegko_aa2543f42cbbe1a9373dc46d04c112bee}{log\+\_\+propagation\+\_\+mode}}}]{mode }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Sets the logger event propagation mode for the executor. 

This controls whether events that happen at objects created on this executor will also be logged at propagating loggers attached to the executor. \begin{DoxySeeAlso}{See also}
Logger\+::needs\+\_\+propagation() 
\end{DoxySeeAlso}
\mbox{\Hypertarget{classgko_1_1Executor_a3d59329aa9e2db037f2ebb6748bf4a5b}\label{classgko_1_1Executor_a3d59329aa9e2db037f2ebb6748bf4a5b}} 
\index{gko::Executor@{gko::Executor}!should\_propagate\_log@{should\_propagate\_log}}
\index{should\_propagate\_log@{should\_propagate\_log}!gko::Executor@{gko::Executor}}
\doxysubsubsection{\texorpdfstring{should\_propagate\_log()}{should\_propagate\_log()}}
{\footnotesize\ttfamily bool gko\+::\+Executor\+::should\+\_\+propagate\+\_\+log (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
\mbox{\hyperlink{classgko_1_1Executor_a8801d54a4ac842def0b88d643b37b1db}{Executor\+::set\+\_\+log\+\_\+propagation\+\_\+mode(log\+\_\+propagation\+\_\+mode)}} 
\end{DoxySeeAlso}
