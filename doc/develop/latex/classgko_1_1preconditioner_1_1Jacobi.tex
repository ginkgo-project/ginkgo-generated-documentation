...
Inheritance diagram for gko\+::preconditioner\+::Jacobi$<$ Value\+Type, Index\+Type $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classgko_1_1preconditioner_1_1Jacobi__inherit__graph}
\end{center}
\end{figure}
...
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \& \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi_a41526f216c3d5583bae6b3775c15ef67}{operator=}} (const \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \&other)
\begin{DoxyCompactList}\small\item\em Copy-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. \end{DoxyCompactList}\item 
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \& \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi_ae0428847456bc329fa8260455cdc0738}{operator=}} (\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \&\&other)
\begin{DoxyCompactList}\small\item\em Move-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. \end{DoxyCompactList}\item 
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi_a51fb3164a0886cb3c48b3c26c6af7513}{Jacobi}} (const \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \&other)
\begin{DoxyCompactList}\small\item\em Copy-\/constructs a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. \end{DoxyCompactList}\item 
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi_a747ca4267e56029521a80410c64a2f13}{Jacobi}} (\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} \&\&other)
\begin{DoxyCompactList}\small\item\em Move-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. \end{DoxyCompactList}\item 
...
\item 
static \mbox{\hyperlink{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type}{parameters\+\_\+type}} \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi_a7f29f4d4e64fe69528696a339803f599}{parse}} (const \mbox{\hyperlink{classgko_1_1config_1_1pnode}{config\+::pnode}} \&config, const \mbox{\hyperlink{classgko_1_1config_1_1registry}{config\+::registry}} \&context, const \mbox{\hyperlink{classgko_1_1config_1_1type__descriptor}{config\+::type\+\_\+descriptor}} \&td\+\_\+for\+\_\+child=config\+::make\+\_\+type\+\_\+descriptor$<$ Value\+Type, Index\+Type $>$())
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_a5e92cc30cca6970856ec2201c2e18d01}\label{classgko_1_1preconditioner_1_1Jacobi_a5e92cc30cca6970856ec2201c2e18d01}} 
class {\bfseries Enable\+Cloneable$<$ Jacobi$<$ Value\+Type, Index\+Type $>$ $>$}
\end{DoxyCompactItemize}
...
When the max\+\_\+block\+\_\+size is set to 1, specialized kernels are used, both for generation (inverting the diagonals) and application (diagonal scaling) to reduce the overhead involved in the usual (adaptive) block case. 
\end{DoxyNote}


\doxysubsection{Constructor \& Destructor Documentation}
\mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_a51fb3164a0886cb3c48b3c26c6af7513}\label{classgko_1_1preconditioner_1_1Jacobi_a51fb3164a0886cb3c48b3c26c6af7513}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}!Jacobi@{Jacobi}}
\index{Jacobi@{Jacobi}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{Jacobi()}{Jacobi()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}$<$ Value\+Type, Index\+Type $>$ \&}]{other }\end{DoxyParamCaption})}



Copy-\/constructs a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. 

Inherits executor, copies all data and parameters. \mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_a747ca4267e56029521a80410c64a2f13}\label{classgko_1_1preconditioner_1_1Jacobi_a747ca4267e56029521a80410c64a2f13}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}!Jacobi@{Jacobi}}
\index{Jacobi@{Jacobi}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{Jacobi()}{Jacobi()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}$<$ Value\+Type, Index\+Type $>$ \&\&}]{other }\end{DoxyParamCaption})}



Move-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. 
...
\mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_a41526f216c3d5583bae6b3775c15ef67}\label{classgko_1_1preconditioner_1_1Jacobi_a41526f216c3d5583bae6b3775c15ef67}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}!operator=@{operator=}}
\index{operator=@{operator=}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{operator=()}{operator=()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}\& \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::operator= (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}$<$ Value\+Type, Index\+Type $>$ \&}]{other }\end{DoxyParamCaption})}



Copy-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. 

Preserves executor, copies all data and parameters. \mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_ae0428847456bc329fa8260455cdc0738}\label{classgko_1_1preconditioner_1_1Jacobi_ae0428847456bc329fa8260455cdc0738}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}!operator=@{operator=}}
\index{operator=@{operator=}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{operator=()}{operator=()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}\& \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::operator= (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}$<$ Value\+Type, Index\+Type $>$ \&\&}]{other }\end{DoxyParamCaption})}



Move-\/assigns a \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} preconditioner. 

Preserves executor, moves all data and parameters. The moved-\/from object will be empty (0x0 and default parameters). \mbox{\Hypertarget{classgko_1_1preconditioner_1_1Jacobi_a7f29f4d4e64fe69528696a339803f599}\label{classgko_1_1preconditioner_1_1Jacobi_a7f29f4d4e64fe69528696a339803f599}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}!parse@{parse}}
\index{parse@{parse}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{parse()}{parse()}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
static \mbox{\hyperlink{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type}{parameters\+\_\+type}} \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parse (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classgko_1_1config_1_1pnode}{config\+::pnode}} \&}]{config,  }\item[{const \mbox{\hyperlink{classgko_1_1config_1_1registry}{config\+::registry}} \&}]{context,  }\item[{const \mbox{\hyperlink{classgko_1_1config_1_1type__descriptor}{config\+::type\+\_\+descriptor}} \&}]{td\+\_\+for\+\_\+child = {\ttfamily config\+:\+:make\+\_\+type\+\_\+descriptor$<$~ValueType,~IndexType~$>$()} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
\mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}} does not support block\+\_\+pointers and storage\+\_\+optimization array. 
\end{DoxyNote}
