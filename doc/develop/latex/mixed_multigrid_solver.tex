...
\DoxyCodeLine{\textcolor{keyword}{using} cg = \mbox{\hyperlink{classgko_1_1solver_1_1Cg}{gko::solver::Cg<MixedType>}};}
\DoxyCodeLine{\textcolor{keyword}{using} ir = \mbox{\hyperlink{classgko_1_1solver_1_1Ir}{gko::solver::Ir<ValueType>}};}
\DoxyCodeLine{\textcolor{keyword}{using} ir2 = \mbox{\hyperlink{classgko_1_1solver_1_1Ir}{gko::solver::Ir<MixedType>}};}
...
\DoxyCodeLine{\textcolor{keyword}{using} bj2 = \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko::preconditioner::Jacobi<MixedType, IndexType>}};}
...
\DoxyCodeLine{\textcolor{keyword}{using} pgm2 = \mbox{\hyperlink{classgko_1_1multigrid_1_1Pgm}{gko::multigrid::Pgm<MixedType, IndexType>}};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} coarsest\_solver\_gen = \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(}
\DoxyCodeLine{    ir::build()}
\DoxyCodeLine{        .with\_solver(bj::build().with\_max\_block\_size(1u).on(exec))}
\DoxyCodeLine{        .with\_relaxation\_factor(static\_cast<ValueType>(0.9))}
\DoxyCodeLine{        .with\_criteria(}
...
\DoxyCodeLine{        .on(exec));}
\DoxyCodeLine{\textcolor{keyword}{auto} coarsest\_solver\_gen2 = \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(}
\DoxyCodeLine{    ir2::build()}
\DoxyCodeLine{        .with\_solver(bj2::build().with\_max\_block\_size(1u).on(exec))}
\DoxyCodeLine{        .with\_relaxation\_factor(static\_cast<MixedType>(0.9))}
\DoxyCodeLine{        .with\_criteria(}
...
\DoxyCodeLine{            \})}
\DoxyCodeLine{            .with\_coarsest\_solver(coarsest\_solver\_gen2)}
\DoxyCodeLine{            .with\_criteria(iter\_stop, tol\_stop)}
\DoxyCodeLine{            .on(exec);}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{    multigrid\_gen = mg::build()}
\DoxyCodeLine{                        .with\_max\_levels(10u)}
\DoxyCodeLine{                        .with\_min\_coarse\_rows(2u)}
\DoxyCodeLine{                        .with\_pre\_smoother(smoother\_gen)}
\DoxyCodeLine{                        .with\_post\_uses\_pre(\textcolor{keyword}{true})}
\DoxyCodeLine{                        .with\_mg\_level(mg\_level\_gen)}
\DoxyCodeLine{                        .with\_coarsest\_solver(coarsest\_solver\_gen)}
\DoxyCodeLine{                        .with\_criteria(iter\_stop, tol\_stop)}
\DoxyCodeLine{                        .on(exec);}
\DoxyCodeLine{\}}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a8c8403e4cdb91e225515ed7d7f6c4463}{write}}(std::cout, \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(initres));}
\DoxyCodeLine{std::cout << \textcolor{stringliteral}{"Final residual norm sqrt(r\string^T r): \(\backslash\)n"};}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a8c8403e4cdb91e225515ed7d7f6c4463}{write}}(std::cout, \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(res));}
\end{DoxyCode}
