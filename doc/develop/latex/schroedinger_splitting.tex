...
This example depends on heat-\/equation.
 ...
 \label{_schroedinger_splitting_Intro}%
 \label{_schroedinger_splitting_Introduction}%
...
\label{_schroedinger_splitting_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_schroedinger_splitting_CommProg}%
...
\DoxyCodeLine{\(\backslash\)f}
\DoxyCodeLine{}
\DoxyCodeLine{Here \(\backslash\)f\(\backslash\)theta\(\backslash\)f is the wave \textcolor{keyword}{function} of a single particle in two dimensions.}
\DoxyCodeLine{Its magnitude \(\backslash\)f|\(\backslash\)theta|\string^2\(\backslash\)f describes the probability distribution of the}
...
\DoxyCodeLine{\textcolor{stringliteral}{fact that \(\backslash\)f| \(\backslash\)theta |\string^2\(\backslash\)f is constant in (2):}}
\DoxyCodeLine{\textcolor{stringliteral}{}}
\DoxyCodeLine{\textcolor{stringliteral}{\(\backslash\)f\{align*\}\{}}
...
\DoxyCodeLine{            set\_val(\&row[3 * j], \mbox{\hyperlink{namespacegko_a99791881a0d56a1c5392ce52b4dce1ac}{abs}}(data[i * n + j]));}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} exec = \mbox{\hyperlink{classgko_1_1OmpExecutor_a8930142a1913bcbcac4fb6c917f930d9}{gko::OmpExecutor::create}}();}
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{comment}{\(\backslash\)f\$}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{Here \(\backslash\)f\$\(\backslash\)theta\(\backslash\)f\$ is the wave function of a single particle in two dimensions.}}
\DoxyCodeLine{\textcolor{comment}{Its magnitude \(\backslash\)f\$|\(\backslash\)theta|\string^2\(\backslash\)f\$ describes the probability distribution of the}}
...
\DoxyCodeLine{\textcolor{comment}{fact that \(\backslash\)f\$| \(\backslash\)theta |\string^2\(\backslash\)f\$ is constant in (2):}}
\DoxyCodeLine{\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\(\backslash\)f\{align*\}\{}}
