...
This example depends on simple-\/solver, poisson-\/solver, three-\/pt-\/stencil-\/solver, .
 ...
 \label{_custom_matrix_format_Intro}%
 \label{_custom_matrix_format_Introduction}%
...
\label{_custom_matrix_format_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_custom_matrix_format_CommProg}%
...
A stencil matrix class representing the 3pt stencil linear operator. We include the \mbox{\hyperlink{classgko_1_1LinOp}{gko\+::\+Lin\+Op}} interface, where we need to implement the two apply\+\_\+impl methods, which get called inside the default implementation of apply (after argument verification) to perform the actual application of the linear operator.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename} ValueType>}
\DoxyCodeLine{\textcolor{keyword}{class }StencilMatrix : \textcolor{keyword}{public} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}},}
...
\DoxyCodeLine{        : \mbox{\hyperlink{namespacegko}{gko}}::LinOp(exec, \mbox{\hyperlink{namespacegko}{gko}}::dim<2>\{size\}),}
...
\DoxyCodeLine{        error +=}
\DoxyCodeLine{            \mbox{\hyperlink{namespacegko_a99791881a0d56a1c5392ce52b4dce1ac}{abs}}(u-\/>\mbox{\hyperlink{classgko_1_1matrix_1_1Dense_ab83c739c1b11abaecc3bfd89506f6c9c}{get\_const\_values}}()[i] -\/ correct\_u(xi)) / \mbox{\hyperlink{namespacegko_a99791881a0d56a1c5392ce52b4dce1ac}{abs}}(correct\_u(xi));}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_custom_matrix_format_Results}%
\doxysection*{Results}

\label{_custom_matrix_format_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_custom_matrix_format_PlainProg}%
...
\DoxyCodeLine{            vec* x;}
\DoxyCodeLine{        \};}
\DoxyCodeLine{        this-\/>\mbox{\hyperlink{classgko_1_1PolymorphicObject_ab40586bff071b7f11c2cf6b5cbf598eb}{get\_executor}}()-\/>run(}
\DoxyCodeLine{            stencil\_operation(coefficients, dense\_b, dense\_x));}
\DoxyCodeLine{    \}}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keywordtype}{void} apply\_impl(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* alpha, \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* b,}
