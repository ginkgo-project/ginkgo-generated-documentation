...
\begin{DoxyEnumerate}
\item First, you can just copy over the \href{https://github.com/ginkgo-project/ginkgo/tree/master/examples/simple-solver}{\texttt{ {\ttfamily doc/}}} folder (you can copy it from the example most relevant to you) and adapt your example names and such, then you can modify the actual documentation.
\end{DoxyEnumerate}
\begin{DoxyItemize}
...
\item In {\ttfamily kind}\+: The kind of the example. For different kinds see \href{https://ginkgo-project.github.io/ginkgo-generated-documentation/doc/master/Examples.html}{\texttt{ the documentation}}. Examples can be of {\ttfamily basic}, {\ttfamily techniques}, {\ttfamily logging}, {\ttfamily stopping\+\_\+criteria} or {\ttfamily preconditioners}. If your example does not fit any of these categories, feel free to create one.
...
\end{DoxyItemize}
\begin{DoxyEnumerate}
\item You also need to modify the \href{https://github.com/ginkgo-project/ginkgo/blob/master/doc/examples/examples.hpp.in}{\texttt{ examples.\+hpp.\+in}} file. You add the name of the example in the main section and in the section that you specified in the {\ttfamily doc/kind} file in the example documentation.
