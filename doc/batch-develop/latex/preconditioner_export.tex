...
\DoxyCodeLine{                   \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1DpcppExecutor_ac46044fcb00b2d224b45d93eaf8c579d}{gko::DpcppExecutor::create}}(}
\DoxyCodeLine{                       0, gko::ReferenceExecutor::create());}
\DoxyCodeLine{               \}\}\};}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_aa24837da3770b3dddf981d9bfe0d3b52}{gko::write}}(stream, mtx, \mbox{\hyperlink{namespacegko_ae749a5ea11a93c1bcc9158d9a6e9fb68af5d7aa3ba4929cc12dc51a92c59fabd3}{gko::layout\_type::coordinate}});}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{        factory-\/>get\_parameters().max\_block\_size = std::stoi(argv[4]);}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{    \textcolor{keywordflow}{if} (argc >= 5) \{}
\DoxyCodeLine{        factory-\/>get\_parameters().iterations = std::stoi(argv[4]);}
\DoxyCodeLine{    \}}
