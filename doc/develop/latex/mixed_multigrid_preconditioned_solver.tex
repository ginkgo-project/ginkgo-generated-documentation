...
This example depends on multigrid-\/preconditioned-\/solver, mixed-\/multigrid-\/solver.
 ...
 \label{_mixed_multigrid_preconditioned_solver_Intro}%
 \label{_mixed_multigrid_preconditioned_solver_Thisexampleshowshowtousethemixedprecisionmultigridpreconditioner}%
...
\label{_mixed_multigrid_preconditioned_solver_CommProg}%
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_mixed_multigrid_preconditioned_solver_Results}%
\doxysection*{Results}
...
\label{_mixed_multigrid_preconditioned_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_mixed_multigrid_preconditioned_solver_PlainProg}%
