...
\DoxyCodeLine{\textcolor{keyword}{auto} mg\_level\_gen2 =}
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(amgx\_pgm2::build().with\_deterministic(\textcolor{keyword}{true}).on(exec));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} multigrid\_gen = mg::build()}
\DoxyCodeLine{                         .with\_max\_levels(2u)}
\DoxyCodeLine{                         .with\_min\_coarse\_rows(5u)}
\DoxyCodeLine{                         .with\_pre\_smoother(smoother\_gen, smoother\_gen2)}
\DoxyCodeLine{                         .with\_post\_uses\_pre(\textcolor{keyword}{true})}
\DoxyCodeLine{                         .with\_mg\_level(mg\_level\_gen, mg\_level\_gen2)}
\DoxyCodeLine{                         .with\_coarsest\_solver(\mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(}
\DoxyCodeLine{                             bj2::build().with\_max\_block\_size(1u).on(exec)))}
