...
This example depends on simple-\/solver.
 ...
 \label{_poisson_solver_Intro}%
 \label{_poisson_solver_Introduction}%
...
\label{_poisson_solver_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_poisson_solver_CommProg}%
...
\DoxyCodeLine{generate\_stencil\_matrix(matrix.get());}
...
\DoxyCodeLine{    -\/>generate(\mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(exec, matrix))  \textcolor{comment}{// copy the matrix to the executor}}
\DoxyCodeLine{    -\/>apply(rhs, u);}
\end{DoxyCode}


Uncomment to print the solution print\+\_\+solution$<$\+Value\+Type$>$(u0, u1, u.\+get());
...
\label{_poisson_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_poisson_solver_PlainProg}%
