...
\begin{DoxyCompactList}\small\item\em Binds a set of device-\/specific kernels to an Operation. \end{DoxyCompactList}\item 
\#define \mbox{\hyperlink{group__Executor_gae20be793db14dfd6249a315281201550}{G\+K\+O\+\_\+\+R\+E\+G\+I\+S\+T\+E\+R\+\_\+\+H\+O\+S\+T\+\_\+\+O\+P\+E\+R\+A\+T\+I\+ON}}(\+\_\+name,  \+\_\+kernel)
\begin{DoxyCompactList}\small\item\em Binds a host-\/side kernel (independent of executor type) to an Operation. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{group__Executor_gae20be793db14dfd6249a315281201550}\label{group__Executor_gae20be793db14dfd6249a315281201550}} 
\index{Executors@{Executors}!GKO\_REGISTER\_HOST\_OPERATION@{GKO\_REGISTER\_HOST\_OPERATION}}
\index{GKO\_REGISTER\_HOST\_OPERATION@{GKO\_REGISTER\_HOST\_OPERATION}!Executors@{Executors}}
\doxysubsubsection{\texorpdfstring{GKO\_REGISTER\_HOST\_OPERATION}{GKO\_REGISTER\_HOST\_OPERATION}}
{\footnotesize\ttfamily \#define G\+K\+O\+\_\+\+R\+E\+G\+I\+S\+T\+E\+R\+\_\+\+H\+O\+S\+T\+\_\+\+O\+P\+E\+R\+A\+T\+I\+ON(\begin{DoxyParamCaption}\item[{}]{\+\_\+name,  }\item[{}]{\+\_\+kernel }\end{DoxyParamCaption})}

{\bfseries Value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template} <\textcolor{keyword}{typename}... Args>                                              \(\backslash\)}
\DoxyCodeLine{    auto make\_\#\#\_name(Args\&\&... args)                                        \(\backslash\)}
\DoxyCodeLine{    \{                                                                        \(\backslash\)}
\DoxyCodeLine{        return ::gko::detail::make\_register\_operation(                       \(\backslash\)}
\DoxyCodeLine{            \#\_kernel,                                                        \(\backslash\)}
\DoxyCodeLine{            [\&args...](\textcolor{keyword}{auto}) \{ \_kernel(std::forward<Args>(args)...); \});     \(\backslash\)}
\DoxyCodeLine{    \}                                                                        \(\backslash\)}
...
\hline
\end{DoxyParams}
\hypertarget{group__Executor_autotoc_md74}{}\doxysubsubsection{Example}\label{group__Executor_autotoc_md74}

\begin{DoxyCode}{0}
\DoxyCodeLine{ \{c++\}}
\DoxyCodeLine{\textcolor{keywordtype}{void} host\_kernel(\textcolor{keywordtype}{int}) \{}
\DoxyCodeLine{    \textcolor{comment}{// do some expensive computations}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Bind the kernels to the operation}}
\DoxyCodeLine{\mbox{\hyperlink{group__Executor_gae20be793db14dfd6249a315281201550}{GKO\_REGISTER\_HOST\_OPERATION}}(my\_op, host\_kernel);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int} main() \{}
\DoxyCodeLine{    \textcolor{comment}{// create executor}}
...
\DoxyCodeLine{}
\DoxyCodeLine{    ref-\/>run(op);  \textcolor{comment}{// run host kernel}}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\hline
\end{DoxyParams}
\hypertarget{group__Executor_autotoc_md73}{}\doxysubsubsection{Example}\label{group__Executor_autotoc_md73}
