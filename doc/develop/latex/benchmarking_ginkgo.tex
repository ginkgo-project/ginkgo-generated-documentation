...
\item Running benchmarks manually
\item Benchmarking with the script utility
...
\item Available benchmark customization options with the script utility.
