...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} logger = std::make\_shared<ResidualLogger<ValueType>>(A.get(), b.get());}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{solver-\/>\mbox{\hyperlink{classgko_1_1LinOp_aff0379dbd0d86bd9ce2db03ac05f789f}{apply}}(b, x);}
\end{DoxyCode}
...
\DoxyCodeLine{    b-\/>\mbox{\hyperlink{classgko_1_1matrix_1_1Dense_aed62418c4ecb58c4855b0bea1b7a680d}{compute\_norm2}}(res);}
\DoxyCodeLine{}
