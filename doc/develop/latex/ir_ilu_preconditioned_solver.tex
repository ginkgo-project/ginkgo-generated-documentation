...
This example depends on ilu-\/preconditioned-\/solver, iterative-\/refinement.
 ...
 \label{_ir_ilu_preconditioned_solver_Intro}%
 \label{_ir_ilu_preconditioned_solver_Introduction}%
\doxysection*{Introduction}

\label{_ir_ilu_preconditioned_solver_Abouttheexample}%
...
\+Triangular Solves\char`\"{} (Göbel, Anzt, Cojean, Flegar, Quintana-\/\+Ortí, Euro-\/\+Par 2020). The theory and a detailed analysis can be found there. \label{_ir_ilu_preconditioned_solver_CommProg}%
...
\DoxyCodeLine{\textcolor{keyword}{auto} clone\_x = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(exec, x);}
\end{DoxyCode}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{auto} trisolve\_factory = \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} ilu\_pre\_factory = \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko::preconditioner::Ilu<ValueType>::build}}()}
\DoxyCodeLine{                           .with\_l\_solver(trisolve\_factory)}
\DoxyCodeLine{                           .with\_u\_solver(trisolve\_factory)}
\DoxyCodeLine{                           .on(exec);}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_ir_ilu_preconditioned_solver_Results}%
\doxysection*{Results}
...
\label{_ir_ilu_preconditioned_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_ir_ilu_preconditioned_solver_PlainProg}%
