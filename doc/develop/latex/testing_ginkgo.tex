\hypertarget{testing_ginkgo_autotoc_md9}{}\doxysubsection{Running the unit tests}\label{testing_ginkgo_autotoc_md9}
You need to compile ginkgo with {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+B\+U\+I\+L\+D\+\_\+\+T\+E\+S\+TS=ON} option to be able to run the tests.\hypertarget{testing_ginkgo_autotoc_md10}{}\doxysubsubsection{Using make test}\label{testing_ginkgo_autotoc_md10}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    Start  1: path/to/test}
\DoxyCodeLine{1/13 Test  \#1: path/to/test .............................   Passed    0.01 sec}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./path/to/test}
\end{DoxyCode}


where {\ttfamily path/to/test} is the path returned by {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md11}{}\doxysubsubsection{Using make quick\+\_\+test}\label{testing_ginkgo_autotoc_md11}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{make quick\_test}
\end{DoxyCode}


These tests do not use G\+PU features except for a few device property queries, so they may still fail if Ginkgo was compiled with G\+PU support, but no such G\+PU is available. The output is equivalent to {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md12}{}\doxysubsubsection{Using C\+Test}\label{testing_ginkgo_autotoc_md12}
The tests can also be ran through C\+Test from the command line, for example when in a configured build directory\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{ctest -\/T start -\/T build -\/T test -\/T submit}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ctest -\/S cmake/CTestScript.cmake}
\end{DoxyCode}
