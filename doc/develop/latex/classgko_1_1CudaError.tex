...
Inheritance diagram for gko\+::Cuda\+Error\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=184pt]{classgko_1_1CudaError__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=184pt]{classgko_1_1CudaError__coll__graph}
\end{center}
\end{figure}
