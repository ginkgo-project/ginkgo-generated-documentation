...
\item In {\ttfamily kind}\+: The kind of the example. For different kinds see \href{https://ginkgo-project.github.io/ginkgo/doc/master/Examples.html}{\texttt{ the documentation}}. Examples can be of {\ttfamily basic}, {\ttfamily techniques}, {\ttfamily logging}, {\ttfamily stopping\+\_\+criteria} or {\ttfamily preconditioners}. If your example does not fit any of these categories, feel free to create one.
