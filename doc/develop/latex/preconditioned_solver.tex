...
This example depends on simple-\/solver.
 ...
 \label{_preconditioned_solver_Intro}%
 \label{_preconditioned_solver_Introduction}%
\doxysection*{Introduction}

\label{_preconditioned_solver_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_preconditioned_solver_CommProg}%
...
\begin{DoxyCode}{0}
\DoxyCodeLine{.with\_preconditioner(bj::build().with\_max\_block\_size(8u))}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_preconditioned_solver_Results}%
\doxysection*{Results}
...
\label{_preconditioned_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_preconditioned_solver_PlainProg}%
