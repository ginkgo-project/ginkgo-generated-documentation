\hypertarget{testing_ginkgo_autotoc_md8}{}\doxysubsection{Running the unit tests}\label{testing_ginkgo_autotoc_md8}
You need to compile ginkgo with {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+B\+U\+I\+L\+D\+\_\+\+T\+E\+S\+TS=ON} option to be able to run the tests.\hypertarget{testing_ginkgo_autotoc_md9}{}\doxysubsubsection{Using make test}\label{testing_ginkgo_autotoc_md9}
...
where {\ttfamily path/to/test} is the path returned by {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md10}{}\doxysubsubsection{Using make quick\+\_\+test}\label{testing_ginkgo_autotoc_md10}
...
These tests do not use G\+PU features except for a few device property queries, so they may still fail if Ginkgo was compiled with G\+PU support, but no such G\+PU is available. The output is equivalent to {\ttfamily make test}.\hypertarget{testing_ginkgo_autotoc_md11}{}\doxysubsubsection{Using C\+Test}\label{testing_ginkgo_autotoc_md11}
