...
Inheritance diagram for gko\+::matrix\+::Identity$<$ Value\+Type $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classgko_1_1matrix_1_1Identity__inherit__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
static std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} $>$ \mbox{\hyperlink{classgko_1_1matrix_1_1Identity_ac8f28ec7da5e01316836ab945725896c}{create}} (std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ exec, \mbox{\hyperlink{structgko_1_1dim}{dim}}$<$ 2 $>$ size)
\begin{DoxyCompactList}\small\item\em Creates an \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} matrix of the specified size. \end{DoxyCompactList}\item 
static std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} $>$ \mbox{\hyperlink{classgko_1_1matrix_1_1Identity_acd22fdf7af691036d70737baead0011d}{create}} (std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$ exec, \mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{size\+\_\+type}} size=0)
\begin{DoxyCompactList}\small\item\em Creates an \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} matrix of the specified size. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Friends}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classgko_1_1matrix_1_1Identity_a4b43f05e40421bf982beefe6fa0a8a9b}\label{classgko_1_1matrix_1_1Identity_a4b43f05e40421bf982beefe6fa0a8a9b}} 
...
\mbox{\Hypertarget{classgko_1_1matrix_1_1Identity_ac8f28ec7da5e01316836ab945725896c}\label{classgko_1_1matrix_1_1Identity_ac8f28ec7da5e01316836ab945725896c}} 
\index{gko::matrix::Identity$<$ ValueType $>$@{gko::matrix::Identity$<$ ValueType $>$}!create@{create}}
\index{create@{create}!gko::matrix::Identity$<$ ValueType $>$@{gko::matrix::Identity$<$ ValueType $>$}}
\doxysubsubsection{\texorpdfstring{create()}{create()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision$>$ \\
static std\+::unique\+\_\+ptr$<$\mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}}$>$ \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{gko\+::matrix\+::\+Identity}}$<$ Value\+Type $>$\+::create (\begin{DoxyParamCaption}\item[{std\+::shared\+\_\+ptr$<$ const \mbox{\hyperlink{classgko_1_1Executor}{Executor}} $>$}]{exec,  }\item[{\mbox{\hyperlink{structgko_1_1dim}{dim}}$<$ 2 $>$}]{size }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Creates an \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} matrix of the specified size. 


\begin{DoxyParams}{Parameters}
{\em exec} & the executor where the \mbox{\hyperlink{classgko_1_1matrix_1_1Identity}{Identity}} operator will be stored \\
\hline
{\em size} & size of the matrix (must be square) \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classgko_1_1matrix_1_1Identity_acd22fdf7af691036d70737baead0011d}\label{classgko_1_1matrix_1_1Identity_acd22fdf7af691036d70737baead0011d}} 
\index{gko::matrix::Identity$<$ ValueType $>$@{gko::matrix::Identity$<$ ValueType $>$}!create@{create}}
\index{create@{create}!gko::matrix::Identity$<$ ValueType $>$@{gko::matrix::Identity$<$ ValueType $>$}}
...
\item 
ginkgo/core/matrix/identity.\+hpp\end{DoxyCompactItemize}
