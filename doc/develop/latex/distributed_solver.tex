...
This distributed solver example should help you understand the basics of using Ginkgo in a distributed setting. The example will solve a simple 1D Laplace equation where the system can be distributed row-\/wise to multiple processes. To run the solver with multiple processes, use {\ttfamily mpirun -\/n N\+U\+M\+\_\+\+P\+R\+O\+CS ./distributed-\/solver \mbox{[}executor\mbox{]} \mbox{[}num\+\_\+grid\+\_\+points\mbox{]}}.
...
\label{_TypeDefinitiions}%
 \doxysubsubsection*{Type Definitiions}
...
\label{_InitializationandUserInputHandling}%
 \doxysubsubsection*{Initialization and User Input Handling}

Since this is an M\+PI program, we need to initialize and finalize M\+PI at the begin and end respectively of our program. This can be easily done with the following helper construct that uses R\+A\+II to automize the initialization and finalization.
...
Create an M\+PI communicator wrapper and get the rank.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1experimental_1_1mpi_1_1communicator}{gko::experimental::mpi::communicator}} comm\{MPI\_COMM\_WORLD\};}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keyword}{auto} rank = comm.\mbox{\hyperlink{classgko_1_1experimental_1_1mpi_1_1communicator_a58c4515edcb0dee79b2be1eb40333a61}{rank}}();}
\end{DoxyCode}
...
\DoxyCodeLine{                  << \textcolor{stringliteral}{" [executor] [num\_grid\_points] "} << std::endl;}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{         [\&] \{}
\DoxyCodeLine{             \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1CudaExecutor_a5dcec3ca1c458382e01191b727959a81}{gko::CudaExecutor::create}}(}
\DoxyCodeLine{                 \mbox{\hyperlink{namespacegko_1_1experimental_1_1mpi_a0ec0c93a068b2c19da8cb5e874bf9f6c}{gko::experimental::mpi::map\_rank\_to\_device\_id}}(}
\DoxyCodeLine{                     MPI\_COMM\_WORLD, \mbox{\hyperlink{classgko_1_1CudaExecutor_aef0258494d14de0e56149b920c5173e5}{gko::CudaExecutor::get\_num\_devices}}()),}
\DoxyCodeLine{                 gko::ReferenceExecutor::create(), \textcolor{keyword}{false},}
\DoxyCodeLine{                 gko::allocation\_mode::device);}
\DoxyCodeLine{         \}\},}
\DoxyCodeLine{        \{\textcolor{stringliteral}{"hip"},}
\DoxyCodeLine{         [\&] \{}
\DoxyCodeLine{             \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1HipExecutor_ad3a72bc42254fb8730bc2090147447d9}{gko::HipExecutor::create}}(}
\DoxyCodeLine{                 \mbox{\hyperlink{namespacegko_1_1experimental_1_1mpi_a0ec0c93a068b2c19da8cb5e874bf9f6c}{gko::experimental::mpi::map\_rank\_to\_device\_id}}(}
\DoxyCodeLine{                     MPI\_COMM\_WORLD, \mbox{\hyperlink{classgko_1_1HipExecutor_a7b34cbd84692dafa2290e6630754aa97}{gko::HipExecutor::get\_num\_devices}}()),}
\DoxyCodeLine{                 gko::ReferenceExecutor::create(), \textcolor{keyword}{true});}
\DoxyCodeLine{         \}\},}
\DoxyCodeLine{        \{\textcolor{stringliteral}{"dpcpp"},}
\DoxyCodeLine{         [\&] \{}
\DoxyCodeLine{             \textcolor{keyword}{auto} ref = gko::ReferenceExecutor::create();}
\DoxyCodeLine{             \textcolor{keywordflow}{if} (\mbox{\hyperlink{classgko_1_1DpcppExecutor_adf306338233c8e8aca0dec96aefe5d93}{gko::DpcppExecutor::get\_num\_devices}}(\textcolor{stringliteral}{"gpu"}) > 0) \{}
...
\DoxyCodeLine{                     \mbox{\hyperlink{namespacegko_1_1experimental_1_1mpi_a0ec0c93a068b2c19da8cb5e874bf9f6c}{gko::experimental::mpi::map\_rank\_to\_device\_id}}(}
\DoxyCodeLine{                         MPI\_COMM\_WORLD,}
\DoxyCodeLine{                         \mbox{\hyperlink{classgko_1_1DpcppExecutor_adf306338233c8e8aca0dec96aefe5d93}{gko::DpcppExecutor::get\_num\_devices}}(\textcolor{stringliteral}{"gpu"})),}
\DoxyCodeLine{                     ref);}
\DoxyCodeLine{             \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\mbox{\hyperlink{classgko_1_1DpcppExecutor_adf306338233c8e8aca0dec96aefe5d93}{gko::DpcppExecutor::get\_num\_devices}}(\textcolor{stringliteral}{"cpu"}) > 0) \{}
\DoxyCodeLine{                 \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1DpcppExecutor_ae9b875dfe3af7f3f3f24071bfb2f895e}{gko::DpcppExecutor::create}}(}
\DoxyCodeLine{                     \mbox{\hyperlink{namespacegko_1_1experimental_1_1mpi_a0ec0c93a068b2c19da8cb5e874bf9f6c}{gko::experimental::mpi::map\_rank\_to\_device\_id}}(}
\DoxyCodeLine{                         MPI\_COMM\_WORLD,}
\DoxyCodeLine{                         \mbox{\hyperlink{classgko_1_1DpcppExecutor_adf306338233c8e8aca0dec96aefe5d93}{gko::DpcppExecutor::get\_num\_devices}}(\textcolor{stringliteral}{"cpu"})),}
\DoxyCodeLine{                     ref);}
...
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keyword}{auto} exec = exec\_map.at(executor\_string)();}
\end{DoxyCode}
...
Assemble the matrix using a 3-\/pt stencil and fill the right-\/hand-\/side with a sine value. The distributed matrix supports only constructing an empty matrix of zero size and filling in the values with \mbox{\hyperlink{classgko_1_1experimental_1_1distributed_1_1Matrix_afb8419e9ac7afca6f347742951056970}{gko\+::experimental\+::distributed\+::\+Matrix\+::read\+\_\+distributed}}. Only the data that belongs to the rows by this rank will be assembled.
...
\DoxyCodeLine{A\_host-\/>read\_distributed(A\_data, partition.get());}
\DoxyCodeLine{b\_host-\/>read\_distributed(b\_data, partition.get());}
\DoxyCodeLine{x\_host-\/>read\_distributed(x\_data, partition.get());}
\end{DoxyCode}
...
\DoxyCodeLine{A-\/>copy\_from(A\_host.get());}
\DoxyCodeLine{b-\/>copy\_from(b\_host.get());}
\DoxyCodeLine{x-\/>copy\_from(x\_host.get());}
\end{DoxyCode}
...
\DoxyCodeLine{            gko::stop::Iteration::build().with\_max\_iters(100u).on(exec),}
...
\DoxyCodeLine{                .with\_reduction\_factor(1e-\/4)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Ainv-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{comm.synchronize();}
\DoxyCodeLine{ValueType t\_solver\_apply\_end = \mbox{\hyperlink{namespacegko_1_1experimental_1_1mpi_a508f97387781bb32dd2c7616dee1a786}{gko::experimental::mpi::get\_walltime}}();}
\end{DoxyCode}


Compute the residual, this is done in the same way as in the non-\/distributed case.


\begin{DoxyCode}{0}
\DoxyCodeLine{x\_host-\/>copy\_from(x.get());}
...
\DoxyCodeLine{\textcolor{keyword}{auto} minus\_one = gko::initialize<vec>(\{-\/1.0\}, exec);}
\DoxyCodeLine{A\_host-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(minus\_one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x\_host), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(\mbox{\hyperlink{namespacegko_a0059e27f8f4bc348ff65c1e60caf47c8}{one}}),}
\DoxyCodeLine{              \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b\_host));}
\DoxyCodeLine{\textcolor{keyword}{auto} res\_norm = gko::initialize<vec>(\{0.0\}, exec-\/>get\_master());}
\DoxyCodeLine{b\_host-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res\_norm));}
\end{DoxyCode}
...
\DoxyCodeLine{          << \textcolor{stringliteral}{"\(\backslash\)nFinal Res norm: "} << *res\_norm-\/>get\_values()}
...
\DoxyCodeLine{          << \textcolor{stringliteral}{"\(\backslash\)nSolver apply time: "} << t\_solver\_apply\_end -\/ t\_solver\_generate\_end}
