The C\+B-\/\+G\+M\+R\+ES solver example..
 ...
 \label{_cb_gmres_Intro}%
 \label{_cb_gmres_Introduction}%
\doxysection*{Introduction}

\label{_cb_gmres_Abouttheexample}%
...
Both solves are timed and the residual norm of each solution is computed to show that both solutions are correct. \label{_cb_gmres_CommProg}%
...
\DoxyCodeLine{                               \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* solver,}
\DoxyCodeLine{                               \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<ValueType>}}* b,}
\DoxyCodeLine{                               \mbox{\hyperlink{classgko_1_1matrix_1_1Dense}{gko::matrix::Dense<ValueType>}}* x)}
\DoxyCodeLine{\{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} x\_copy = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(x);}
...
\DoxyCodeLine{\textcolor{keyword}{auto} b = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(exec, b\_host);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} x\_keep = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(b);}
\DoxyCodeLine{\textcolor{keyword}{auto} x\_reduce = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(x\_keep);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keyword}{auto} tmp = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(b);}
\end{DoxyCode}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, res\_norm\_keep);}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, res\_norm\_reduce);}
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_cb_gmres_Results}%
\doxysection*{Results}
...
\label{_cb_gmres_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_cb_gmres_PlainProg}%
