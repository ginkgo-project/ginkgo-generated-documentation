...
\begin{DoxyCompactList}\small\item\em Call if a stop occurred due to a hard limit (and convergence was not reached). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Call if convergence occurred. \end{DoxyCompactList}\item 
