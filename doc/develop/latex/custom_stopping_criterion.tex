...
This example depends on simple-\/solver, minimal-\/cuda-\/solver.
 ...
 \label{_custom_stopping_criterion_Intro}%
 \label{_custom_stopping_criterion_Introduction}%
\doxysection*{Introduction}

\label{_custom_stopping_criterion_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_custom_stopping_criterion_CommProg}%
...
\DoxyCodeLine{}
\DoxyCodeLine{/ **}
\DoxyCodeLine{ * The ByInteraction \textcolor{keyword}{class }is a \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a4d4b370ab9b3dbca1ccdb1a5cca6a728}{criterion}} which asks for \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27aee11cbb19052e40b07aac0ca060c23ee}{user}} input to stop}
\DoxyCodeLine{ * the iteration process. Using \textcolor{keyword}{this} \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a4d4b370ab9b3dbca1ccdb1a5cca6a728}{criterion}} is slightly more complex than the}
\DoxyCodeLine{ * other ones, because it is asynchronous therefore requires the use of threads.}
\DoxyCodeLine{ * /}
\DoxyCodeLine{\textcolor{keyword}{class }ByInteraction : \textcolor{keyword}{public} \mbox{\hyperlink{classgko_1_1stop_1_1Criterion}{gko::stop::Criterion}} \{}
\DoxyCodeLine{    \textcolor{keyword}{friend} \textcolor{keyword}{class }\mbox{\hyperlink{classgko_1_1stop_1_1Criterion}{gko::stop::Criterion}};}
\DoxyCodeLine{    \textcolor{keyword}{using} Criterion = \mbox{\hyperlink{classgko_1_1stop_1_1Criterion}{gko::stop::Criterion}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \{}
\DoxyCodeLine{        / **}
\DoxyCodeLine{         * Boolean set by the \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27aee11cbb19052e40b07aac0ca060c23ee}{user}} to stop the iteration process}
\DoxyCodeLine{         * /}
...
\DoxyCodeLine{        : Criterion(std::move(exec))}
\DoxyCodeLine{    \{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{        : Criterion(\mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a9549dd6065d019211460c59a86dd6536}{factory}}-\/>\mbox{\hyperlink{classgko_1_1PolymorphicObject_ab40586bff071b7f11c2cf6b5cbf598eb}{get\_executor}}()),}
\DoxyCodeLine{          parameters\_\{\mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a9549dd6065d019211460c59a86dd6536}{factory}}-\/>get\_parameters()\}}
\DoxyCodeLine{    \{\}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{    bicg::build()}
\DoxyCodeLine{        .with\_criteria(ByInteraction::build().with\_stop\_iteration\_process(}
\DoxyCodeLine{            stop\_iteration\_process))}
\DoxyCodeLine{        .on(exec)}
\DoxyCodeLine{        -\/>generate(A);}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a7cbf673200498a0d1324f4330825202a}{solver}}-\/>add\_logger(\mbox{\hyperlink{classgko_1_1log_1_1Stream}{gko::log::Stream<ValueType>::create}}(}
\DoxyCodeLine{    gko::log::Logger::iteration\_complete\_mask, std::cout, \textcolor{keyword}{true}));}
...
\DoxyCodeLine{    A-\/>apply(\mbox{\hyperlink{namespacegko_a0059e27f8f4bc348ff65c1e60caf47c8}{one}}, x, neg\_one, b);}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_custom_stopping_criterion_Results}%
\doxysection*{Results}
...
\DoxyCodeLine{User input command \textcolor{stringliteral}{'stop'} -\/ The \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a7cbf673200498a0d1324f4330825202a}{solver}} will stop}
\DoxyCodeLine{}
...
\label{_custom_stopping_criterion_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_custom_stopping_criterion_PlainProg}%
