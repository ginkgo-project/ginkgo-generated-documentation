...
This example depends on simple-\/solver, poisson-\/solver, three-\/pt-\/stencil-\/solver, .
 ...
 \label{_kokkos_assembly_Intro}%
 \label{_kokkos_assembly_Introduction}%
...
\label{_kokkos_assembly_Notes}%
\doxysubsubsection*{Notes }

If this example is built as part of Ginkgo, it is advised to configure Ginkgo with {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+W\+I\+T\+H\+\_\+\+C\+C\+A\+C\+HE=O\+FF} to prevent incompabilities with Kokkos\textquotesingle{} compiler wrapper for {\ttfamily nvcc}. \label{_kokkos_assembly_CommProg}%
...
\DoxyCodeLine{}
\DoxyCodeLine{/ **}
\DoxyCodeLine{ * Specialization of type mapper \textcolor{keywordflow}{for} \mbox{\hyperlink{classgko_1_1device__matrix__data}{gko::device\_matrix\_data}}.}
\DoxyCodeLine{ *}
\DoxyCodeLine{ * @tparam ValueType  The value type of the matrix elements}
\DoxyCodeLine{ * @tparam IndexType   The index type of the matrix elements}
\DoxyCodeLine{ * @tparam MemorySpace  The Kokkos \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27acd69b4957f06cd818d7bf3d61980e291}{memory}} space to use.}
\DoxyCodeLine{ * /}
...
\DoxyCodeLine{}
\DoxyCodeLine{    / **}
\DoxyCodeLine{     * This \textcolor{keyword}{struct }defines the layout of the device\_matrix\_data type in terms}
\DoxyCodeLine{     * of arrays.}
\DoxyCodeLine{     *}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_kokkos_assembly_Results}%
\doxysection*{Results}
...
The actual error depends on the used hardware. \label{_kokkos_assembly_PlainProg}%
