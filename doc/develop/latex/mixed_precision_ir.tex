...
This example depends on iterative-\/refinement.
 ...
 \label{_mixed_precision_ir_Intro}%
 \label{_mixed_precision_ir_ThisexamplemanuallyimplementsaMixedPrecisionIterativeRefinementMPIRsolver}%
...
\label{_mixed_precision_ir_CommProg}%
...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, initres\_vec);}
\DoxyCodeLine{std::cout << \textcolor{stringliteral}{"Final residual norm sqrt(r\string^T r):\(\backslash\)n"};}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, res\_vec);}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_mixed_precision_ir_Results}%
\doxysection*{Results}
...
\label{_mixed_precision_ir_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_mixed_precision_ir_PlainProg}%
