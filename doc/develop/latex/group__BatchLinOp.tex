...
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{classgko_1_1batch_1_1matrix_1_1Dense}{Dense}} is a batch matrix format which explicitly stores all values of the matrix in each of the batches. \end{DoxyCompactList}\end{DoxyCompactItemize}
