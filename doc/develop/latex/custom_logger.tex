...
This example depends on simple-\/solver, simple-\/solver-\/logging, minimal-\/cuda-\/solver.
 ...
 \label{_custom_logger_Intro}%
 \label{_custom_logger_Introduction}%
...
\label{_custom_logger_Abouttheexample}%
...
\end{DoxyEnumerate}\label{_custom_logger_CommProg}%
 \doxysection*{The commented program}

\label{_custom_logger_Includefiles}%
...
\begin{DoxyCode}{0}
\DoxyCodeLine{b-\/>\mbox{\hyperlink{classgko_1_1matrix_1_1Dense_aed62418c4ecb58c4855b0bea1b7a680d}{compute\_norm2}}(b\_norm);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    \textcolor{keywordflow}{return} get\_first\_element(b\_norm.get());}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}()\textcolor{keyword}{ const}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} on\_iteration\_complete(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* solver, \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* b,}
...
\DoxyCodeLine{                           \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* implicit\_sq\_residual\_norm,}
\DoxyCodeLine{                           \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1array}{gko::array<gko::stopping\_status>}}*,}
\DoxyCodeLine{                           \textcolor{keywordtype}{bool})\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{}\{}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{recurrent\_norms.push\_back(get\_first\_element(dense\_norm));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} norm = compute\_norm(dense\_residual);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} matrix = gko::as<gko::solver::detail::SolverBaseLinOp>(solver)}
\DoxyCodeLine{                  -\/>get\_system\_matrix();}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} res = gko::as<gko\_dense>(\mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(b));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{matrix-\/>apply(one, solution, neg\_one, res);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    real\_norms.push\_back(compute\_norm(res.get()));}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    implicit\_norms.push\_back(std::sqrt(get\_first\_element(dense\_norm)));}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\end{DoxyCode}
...
\label{_custom_logger_Wheredoyouwanttorunyoursolver}%
...
\label{_custom_logger_Readingyourdataandtransfertotheproperdevice}%
...
\label{_custom_logger_Creatingthesolver}%
...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, x);}
\end{DoxyCode}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a577a2f0345ee607f64277b3364b6431b}{write}}(std::cout, res);}
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_custom_logger_Results}%
\doxysection*{Results}
...
\label{_custom_logger_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_custom_logger_PlainProg}%
