...
Documentation uses standard Doxygen.\hypertarget{contributing_guidelines_autotoc_md59}{}\doxysubsection{Command prefix\+: $<$tt$>$@$<$/tt$>$ for Doxygen, $<$tt$>$\textbackslash{}$<$/tt$>$ for math}\label{contributing_guidelines_autotoc_md59}
Doxygen accepts both {\ttfamily \textbackslash{}cmd} and {\ttfamily @cmd} and treats them identically. Ginkgo uses the at-\/sign for all Doxygen commands ({\ttfamily @brief}, {\ttfamily @param}, {\ttfamily @tparam}, {\ttfamily @return}, {\ttfamily @note}, {\ttfamily @ingroup}, {\ttfamily @ref}, ...) and reserves the backslash for the La\+TeX formula delimiters {\ttfamily \textbackslash{}f\$ ... \textbackslash{}f\$} and {\ttfamily \textbackslash{}f\mbox{[} ... \textbackslash{}f\mbox{]}}.

Keeping the two apart means that the prefix tells you what you are looking at\+: {\ttfamily @} introduces Doxygen structure, {\ttfamily \textbackslash{}} introduces La\+TeX. It also keeps a formula visually consistent with the math it contains, as in {\ttfamily \textbackslash{}f\$\textbackslash{}alpha \textbackslash{}frac\{a\}\{b\}\textbackslash{}f\$}.\hypertarget{contributing_guidelines_autotoc_md60}{}\doxysubsection{Developer targeted notes}\label{contributing_guidelines_autotoc_md60}
