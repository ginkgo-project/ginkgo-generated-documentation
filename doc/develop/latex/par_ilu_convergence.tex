...
This example depends on simple-\/solver.
 ...
 \label{_par_ilu_convergence_Intro}%
 \label{_par_ilu_convergence_Introduction}%
\doxysection*{Introduction}

\label{_par_ilu_convergence_Abouttheexample}%
\doxysubsubsection*{About the example }

This example can be used to inspect the convergence behavior of parallel incomplete factorizations. \label{_par_ilu_convergence_CommProg}%
...
\DoxyCodeLine{         [] \{}
\DoxyCodeLine{             \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1CudaExecutor_a6c423656c7c0eb53810cb77bb4a66d15}{gko::CudaExecutor::create}}(0, \mbox{\hyperlink{classgko_1_1OmpExecutor_a8930142a1913bcbcac4fb6c917f930d9}{gko::OmpExecutor::create}}());}
\DoxyCodeLine{         \}\},}
...
\DoxyCodeLine{             \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1DpcppExecutor_ae9b875dfe3af7f3f3f24071bfb2f895e}{gko::DpcppExecutor::create}}(0, \mbox{\hyperlink{classgko_1_1OmpExecutor_a8930142a1913bcbcac4fb6c917f930d9}{gko::OmpExecutor::create}}());}
\DoxyCodeLine{         \}\}\};}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{    residual\_data.\mbox{\hyperlink{structgko_1_1matrix__data_ab2094160087e0d7fcbb85120f2138b52}{sort\_row\_major}}();}
\DoxyCodeLine{    mtx\_data.\mbox{\hyperlink{structgko_1_1matrix__data_ab2094160087e0d7fcbb85120f2138b52}{sort\_row\_major}}();}
...
\DoxyCodeLine{    \}));}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keyword}{auto} factory\_generator =}
\DoxyCodeLine{        [\&](\mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{gko::size\_type}} iteration) -\/> std::shared\_ptr<gko::LinOpFactory> \{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (precond == \textcolor{stringliteral}{"parilu"}) \{}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1factorization_1_1ParIlu}{gko::factorization::ParIlu<ValueType, IndexType>::build}}()}
\DoxyCodeLine{                .with\_iterations(iteration)}
\DoxyCodeLine{                .on(exec);}
\DoxyCodeLine{        \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (precond == \textcolor{stringliteral}{"paric"}) \{}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1factorization_1_1ParIc}{gko::factorization::ParIc<ValueType, IndexType>::build}}()}
\DoxyCodeLine{                .with\_iterations(iteration)}
\DoxyCodeLine{                .on(exec);}
\DoxyCodeLine{        \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (precond == \textcolor{stringliteral}{"parilut"}) \{}
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1factorization_1_1ParIlut}{gko::factorization::ParIlut<ValueType, IndexType>::build}}()}
...
\DoxyCodeLine{            \textcolor{keywordflow}{return} \mbox{\hyperlink{classgko_1_1factorization_1_1ParIct}{gko::factorization::ParIct<ValueType, IndexType>::build}}()}
\DoxyCodeLine{                .with\_fill\_in\_limit(limit)}
\DoxyCodeLine{                .with\_iterations(iteration)}
\DoxyCodeLine{                .on(exec);}
\DoxyCodeLine{        \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{            GKO\_NOT\_IMPLEMENTED;}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \};}
\DoxyCodeLine{}
...
\DoxyCodeLine{        \textcolor{keyword}{auto} \mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a9549dd6065d019211460c59a86dd6536}{factory}} = factory\_generator(it);}
...
\DoxyCodeLine{                gko::as<gko::Composition<ValueType>>(\mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a9549dd6065d019211460c59a86dd6536}{factory}}-\/>generate(mtx));}
\DoxyCodeLine{            exec-\/>synchronize();}
\DoxyCodeLine{            \textcolor{keyword}{auto} toc = std::chrono::high\_resolution\_clock::now();}
\DoxyCodeLine{            \textcolor{keyword}{auto} residual = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(exec, mtx);}
\DoxyCodeLine{            result-\/>get\_operators()[0]-\/>apply(one, result-\/>get\_operators()[1],}
\DoxyCodeLine{                                              minus\_one, residual);}
...
\DoxyCodeLine{                compute\_ilu\_residual\_norm(residual.get(), mtx.get()));}
\DoxyCodeLine{        \}}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_par_ilu_convergence_Results}%
\doxysection*{Results}
...
\label{_par_ilu_convergence_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_par_ilu_convergence_PlainProg}%
