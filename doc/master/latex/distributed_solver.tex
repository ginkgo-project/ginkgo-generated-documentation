...
Assemble the matrix using a 3-\/pt stencil and fill the right-\/hand-\/side with a sine value. The distributed matrix supports only constructing an empty matrix of zero size and filling in the values with \mbox{\hyperlink{classgko_1_1experimental_1_1distributed_1_1Matrix_a114d34ef21e9feb1ee2ac9d0adbb609e}{gko\+::experimental\+::distributed\+::\+Matrix\+::read\+\_\+distributed}}. Only the data that belongs to the rows by this rank will be assembled.
