...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{classgko_1_1Error__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=184pt]{classgko_1_1Error__coll__graph}
\end{center}
\end{figure}
\doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classgko_1_1Error_a750493241a840d96cafbf9c84cfd4f52}{Error}} (const std\+::string \&file, int line, const std\+::string \&what)
\begin{DoxyCompactList}\small\item\em Initializes an error. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\DoxyCodeLine{        \textcolor{keyword}{auto} y = apply(A, x);}
\DoxyCodeLine{    \} \textcolor{keywordflow}{catch}(\mbox{\hyperlink{classgko_1_1Error}{Error}} e) \{}
\DoxyCodeLine{        \textcolor{comment}{// an error occurred, write the message to screen and exit}}
