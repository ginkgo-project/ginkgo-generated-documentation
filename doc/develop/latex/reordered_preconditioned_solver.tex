...
This example depends on preconditioned-\/solver.
 ...
 \label{_reordered_preconditioned_solver_Intro}%
 \label{_reordered_preconditioned_solver_Introduction}%
\doxysection*{Introduction}

\label{_reordered_preconditioned_solver_Abouttheexample}%
\doxysubsubsection*{About the example }

This uses an R\+CM reordering on an input matrix to construct a Par\+I\+LU preconditioned solver and solve a linear system. \label{_reordered_preconditioned_solver_CommProg}%
...
\DoxyCodeLine{\textcolor{keyword}{using} ilu = \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko::preconditioner::Ilu<ValueType, false, IndexType>}};}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_reordered_preconditioned_solver_Results}%
\doxysection*{Results}
...
\end{DoxyCode}
 \label{_reordered_preconditioned_solver_PlainProg}%
