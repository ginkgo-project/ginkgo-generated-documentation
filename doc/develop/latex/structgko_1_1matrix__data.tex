...
\item 
\mbox{\Hypertarget{structgko_1_1matrix__data_a083205dc2d87cf76f02d050a2cc576bd}\label{structgko_1_1matrix__data_a083205dc2d87cf76f02d050a2cc576bd}} 
...
\mbox{\Hypertarget{structgko_1_1matrix__data_ab2094160087e0d7fcbb85120f2138b52}\label{structgko_1_1matrix__data_ab2094160087e0d7fcbb85120f2138b52}} 
void \mbox{\hyperlink{structgko_1_1matrix__data_ab2094160087e0d7fcbb85120f2138b52}{sort\+\_\+row\+\_\+major}} ()
\begin{DoxyCompactList}\small\item\em Sorts the nonzero vector so the values follow row-\/major order. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Sorts the nonzero vector so the values follow row-\/major order. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{structgko_1_1matrix__data_a7b360eaf4c11e846c561f2910e2d425f}\label{structgko_1_1matrix__data_a7b360eaf4c11e846c561f2910e2d425f}} 
void \mbox{\hyperlink{structgko_1_1matrix__data_a7b360eaf4c11e846c561f2910e2d425f}{remove\+\_\+zeros}} ()
\begin{DoxyCompactList}\small\item\em Remove entries with value zero from the matrix data. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{structgko_1_1matrix__data_aafdce2b510afe4e0aa0645a734f240a3}{sum\+\_\+duplicates}} ()
\begin{DoxyCompactList}\small\item\em Sum up all values that refer to the same matrix entry. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
std\+::vector$<$ \mbox{\hyperlink{structgko_1_1matrix__data__entry}{nonzero\+\_\+type}} $>$ \mbox{\hyperlink{structgko_1_1matrix__data_a4f6be92270fa96bccdc502c83d248dc0}{nonzeros}}
...
All Ginkgo functions that take this structure as input expect that the nonzeros are sorted in row-\/major order and that the index pair (row\+\_\+index, column\+\_\+index) of each nonzero is unique. 
...
\begin{DoxyParams}{Parameters}
{\em size\+\_\+} & size of the block-\/matrix (in blocks) \\
\hline
{\em block} & matrix block used to fill the complete matrix \\
\hline
\end{DoxyParams}
...
\hline
{\em block} & matrix used to fill diagonal blocks\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
References gko\+::is\+\_\+nonzero(), and gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::nonzeros.
...
\mbox{\Hypertarget{structgko_1_1matrix__data_aafdce2b510afe4e0aa0645a734f240a3}\label{structgko_1_1matrix__data_aafdce2b510afe4e0aa0645a734f240a3}} 
\index{gko::matrix\_data$<$ ValueType, IndexType $>$@{gko::matrix\_data$<$ ValueType, IndexType $>$}!sum\_duplicates@{sum\_duplicates}}
\index{sum\_duplicates@{sum\_duplicates}!gko::matrix\_data$<$ ValueType, IndexType $>$@{gko::matrix\_data$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{sum\_duplicates()}{sum\_duplicates()}}
{\footnotesize\ttfamily template$<$typename Value\+Type = default\+\_\+precision, typename Index\+Type = int32$>$ \\
void \mbox{\hyperlink{structgko_1_1matrix__data}{gko\+::matrix\+\_\+data}}$<$ Value\+Type, Index\+Type $>$\+::sum\+\_\+duplicates (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
References gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::nonzeros, and gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::sort\+\_\+row\+\_\+major().
...
{\footnotesize\ttfamily template$<$typename Value\+Type = default\+\_\+precision, typename Index\+Type = int32$>$ \\
std\+::vector$<$\mbox{\hyperlink{structgko_1_1matrix__data__entry}{nonzero\+\_\+type}}$>$ \mbox{\hyperlink{structgko_1_1matrix__data}{gko\+::matrix\+\_\+data}}$<$ Value\+Type, Index\+Type $>$\+::nonzeros}
...
Referenced by gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::diag(), gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::remove\+\_\+zeros(), gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::sort\+\_\+row\+\_\+major(), and gko\+::matrix\+\_\+data$<$ Value\+Type, Index\+Type $>$\+::sum\+\_\+duplicates().
