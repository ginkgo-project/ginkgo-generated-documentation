...
This example depends on multigrid-\/preconditioned-\/solver.
 ...
 \label{_multigrid_preconditioned_solver_customized_Intro}%
 \label{_multigrid_preconditioned_solver_customized_Thisexampleshowshowtocustomizethemultigridpreconditioner}%
...
\label{_multigrid_preconditioned_solver_customized_CommProg}%
...
\DoxyCodeLine{\textcolor{keyword}{using} ic = \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ic}{gko::preconditioner::Ic<ValueType>}};}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_multigrid_preconditioned_solver_customized_Results}%
\doxysection*{Results}
...
\label{_multigrid_preconditioned_solver_customized_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_multigrid_preconditioned_solver_customized_PlainProg}%
