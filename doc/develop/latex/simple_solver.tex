The simple solver example..
 ...
 \label{_simple_solver_Intro}%
 \label{_simple_solver_Introduction}%
...
\label{_simple_solver_Abouttheexample}%
...
\end{DoxyEnumerate}\label{_simple_solver_CommProg}%
 \doxysection*{The commented program}

\label{_simple_solver_Includefiles}%
...
\label{_simple_solver_Wheredoyouwanttorunyoursolver}%
...
\label{_simple_solver_Readingyourdataandtransfertotheproperdevice}%
...
\label{_simple_solver_Creatingthesolver}%
...
\label{_simple_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_simple_solver_PlainProg}%
