...
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{classgko_1_1batch_1_1matrix_1_1Ell}{Ell}} is a sparse matrix format that stores the same number of nonzeros in each row, enabling coalesced accesses. \end{DoxyCompactList}\end{DoxyCompactItemize}
