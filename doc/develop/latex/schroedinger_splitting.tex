...
\begin{DoxyCode}{0}
\DoxyCodeLine{fft-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(amplitude), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(frequency));}
\DoxyCodeLine{\textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < n; i++) \{}
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < n; j++) \{}
...
\DoxyCodeLine{    \}}
\DoxyCodeLine{\}}
\DoxyCodeLine{ifft-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(frequency), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{lend}}(amplitude));}
\end{DoxyCode}
