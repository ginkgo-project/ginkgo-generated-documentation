The ginkgo overhead measurement example..
 ...
 \label{_ginkgo_overhead_Intro}%
 \label{_ginkgo_overhead_Introduction}%
\doxysection*{Introduction}

\label{_ginkgo_overhead_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_ginkgo_overhead_CommProg}%
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_ginkgo_overhead_Results}%
\doxysection*{Results}
...
\label{_ginkgo_overhead_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_ginkgo_overhead_PlainProg}%
