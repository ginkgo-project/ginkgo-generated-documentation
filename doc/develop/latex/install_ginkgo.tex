...
\item {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+B\+U\+I\+L\+D\+\_\+\+H\+W\+L\+OC=\{ON, O\+FF\}} builds Ginkgo with H\+W\+L\+OC. If system H\+W\+L\+OC is not found, Ginkgo will try to build it. Default is {\ttfamily ON}.
...
\item powershell\+: {\ttfamily \$env\+:C\+X\+X\+F\+L\+A\+GS=\textbackslash{}bigobj}
\end{DoxyItemize}
\end{DoxyItemize}
