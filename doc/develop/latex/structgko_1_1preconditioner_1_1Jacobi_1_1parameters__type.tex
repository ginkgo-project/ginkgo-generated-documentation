...
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_abbc5a550d6f086985234fa6aef37c794}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_abbc5a550d6f086985234fa6aef37c794}} 
...
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a2f2dac4a57fba4def1ba30bea205aed2}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a2f2dac4a57fba4def1ba30bea205aed2}} 
{\footnotesize template$<$typename... Args$>$ }\\auto {\bfseries with\+\_\+max\+\_\+block\+\_\+stride} (Args \&\&... \+\_\+value) -\/$>$ std\+::decay\+\_\+t$<$ decltype($\ast$(this-\/$>$self()))$>$ \&
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a42d18da8ac8ded3aec79cf2fa4575810}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a42d18da8ac8ded3aec79cf2fa4575810}} 
...
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a5dc57e6bb91a7d284cef5218c576b798}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a5dc57e6bb91a7d284cef5218c576b798}} 
...
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_af7e207f61638f863ada54fc5f045a5b4}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_af7e207f61638f863ada54fc5f045a5b4}} 
{\footnotesize template$<$typename... Args$>$ }\\auto {\bfseries with\+\_\+aggregate\+\_\+l1} (Args \&\&... \+\_\+value) -\/$>$ std\+::decay\+\_\+t$<$ decltype($\ast$(this-\/$>$self()))$>$ \&
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a4296ff044ae7cc9628ef1ff3caee94d2}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a4296ff044ae7cc9628ef1ff3caee94d2}} 
{\footnotesize template$<$typename... Args$>$ }\\auto {\bfseries with\+\_\+storage\+\_\+optimization} (Args \&\&... \+\_\+value) -\/$>$ std\+::decay\+\_\+t$<$ decltype($\ast$(this-\/$>$self()))$>$ \&
\item 
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a36ce5f78967eb4e39db2f2bac6b5262e}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_a36ce5f78967eb4e39db2f2bac6b5262e}} 
{\footnotesize template$<$typename... Args$>$ }\\auto {\bfseries with\+\_\+accuracy} (Args \&\&... \+\_\+value) -\/$>$ std\+::decay\+\_\+t$<$ decltype($\ast$(this-\/$>$self()))$>$ \&
...
bool \mbox{\hyperlink{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_afa467c5ec8491236cde56117b09cd821}{aggregate\+\_\+l1}} \{ false \}
\begin{DoxyCompactList}\small\item\em Use L1 \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}, introduced by Baker et al. \end{DoxyCompactList}\item 
...
The parameter represents the number of correct digits in the result of \mbox{\hyperlink{classgko_1_1LinOp_af9979dfd1401bd219b02caaaa445b893}{Jacobi\+::apply()}} operation of the adaptive variant, compared to the non-\/adaptive variant. In other words, the total preconditioning error will be\+:
...
Larger values reduce the volume of memory transfer, but increase the error compared to using full precision storage. Thus, tuning the accuracy to a value as close as possible to {\ttfamily dropout} will result in optimal memory savings, while not degrading the quality of solution. \mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_afa467c5ec8491236cde56117b09cd821}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_afa467c5ec8491236cde56117b09cd821}} 
\index{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$::parameters\_type@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$::parameters\_type}!aggregate\_l1@{aggregate\_l1}}
\index{aggregate\_l1@{aggregate\_l1}!gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$::parameters\_type@{gko::preconditioner::Jacobi$<$ ValueType, IndexType $>$::parameters\_type}}
\doxysubsubsection{\texorpdfstring{aggregate\_l1}{aggregate\_l1}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
bool \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::aggregate\+\_\+l1 \{ false \}}



Use L1 \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{Jacobi}}, introduced by Baker et al. 

The smoother applies whenever the matrix satisfies the row-\/dominance condition \[ A_{ii} \geq \theta \sum_{j \in \text{off-diagonal block}} |A_{ij}|, \qquad \theta \geq 0. \] If set, the preconditioner is generated on $ A + \mathrm{diag}\!\left( \sum_{k \in \text{off-diagonal block of } i} |A_{ik}| \right) $ instead of $A$ — i.\+e. the absolute values of off-\/diagonal-\/block entries on each row are aggregated into the diagonal entry before block inversion.

\begin{DoxyParagraph}{References}

\begin{DoxyItemize}
\item Baker, A. H., Falgout, R. D., Kolev, T. V., Yang, U. M. {\itshape Multigrid Smoothers for Ultraparallel Computing.} S\+I\+AM Journal on Scientific Computing, 33 (5), 2864–2887, 2011. \href{https://doi.org/10.1137/100798806}{\texttt{ https\+://doi.\+org/10.\+1137/100798806}} 
\end{DoxyItemize}
\end{DoxyParagraph}
\mbox{\Hypertarget{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_ad90b07202f15b6cd5c649f6b61480053}\label{structgko_1_1preconditioner_1_1Jacobi_1_1parameters__type_ad90b07202f15b6cd5c649f6b61480053}} 
...
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{classgko_1_1array}{gko\+::array}}$<$index\+\_\+type$>$ \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::block\+\_\+pointers \{ nullptr \}}
...
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{namespacegko_a318c831e3fe269ba04c6ed8bf5a71073}{uint32}} \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::max\+\_\+block\+\_\+size \{ 32u \}}
...
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
\mbox{\hyperlink{namespacegko_a318c831e3fe269ba04c6ed8bf5a71073}{uint32}} \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::max\+\_\+block\+\_\+stride \{ 0u \}}
...
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
bool \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::skip\+\_\+sorting \{ false \}}
...
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
storage\+\_\+optimization\+\_\+type \mbox{\hyperlink{classgko_1_1preconditioner_1_1Jacobi}{gko\+::preconditioner\+::\+Jacobi}}$<$ Value\+Type, Index\+Type $>$\+::parameters\+\_\+type\+::storage\+\_\+optimization \{ \mbox{\hyperlink{classgko_1_1precision__reduction}{precision\+\_\+reduction}}(0, 0) \}}
