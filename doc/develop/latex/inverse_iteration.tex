...
This example depends on simple-\/solver, .
 ...
 \label{_inverse_iteration_Intro}%
 \label{_inverse_iteration_Introduction}%
...
\label{_inverse_iteration_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_inverse_iteration_CommProg}%
...
\DoxyCodeLine{                           system\_max\_iterations),}
\DoxyCodeLine{                       \mbox{\hyperlink{classgko_1_1stop_1_1ResidualNorm}{gko::stop::ResidualNorm<precision>::build}}()}
...
\DoxyCodeLine{    \}}
\DoxyCodeLine{    \textcolor{keywordflow}{return} \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(exec, work);}
\DoxyCodeLine{\}();}
\DoxyCodeLine{\textcolor{keyword}{auto} y = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(x);}
\DoxyCodeLine{\textcolor{keyword}{auto} tmp = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(x);}
\DoxyCodeLine{\textcolor{keyword}{auto} norm = gko::initialize<real\_vec>(\{1.0\}, exec);}
\DoxyCodeLine{\textcolor{keyword}{auto} inv\_norm = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(this\_exec, one);}
\DoxyCodeLine{\textcolor{keyword}{auto} g = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(one);}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_1_1log_a15f71654c6c4f4defc95f9359343fa27a7cbf673200498a0d1324f4330825202a}{solver}}-\/>apply(x, y);}
\DoxyCodeLine{system\_matrix-\/>apply(one, y, neg\_one, x);}
\DoxyCodeLine{x-\/>compute\_norm2(norm);}
\DoxyCodeLine{std::cout << \textcolor{stringliteral}{"\(\backslash\)"system\_residual\(\backslash\)": "}}
\DoxyCodeLine{          << \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(this\_exec, norm)-\/>get\_values()[0] << \textcolor{stringliteral}{", "};}
\DoxyCodeLine{x-\/>copy\_from(y);}
\end{DoxyCode}
...
\DoxyCodeLine{    real\_precision\{1.0\} / \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(this\_exec, norm)-\/>get\_values()[0];}
\DoxyCodeLine{x-\/>scale(\mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(exec, inv\_norm));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{A-\/>apply(x, tmp);}
\DoxyCodeLine{x-\/>compute\_conj\_dot(tmp, g);}
\DoxyCodeLine{\textcolor{keyword}{auto} g\_val = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(this\_exec, g)-\/>get\_values()[0];}
...
\DoxyCodeLine{        tmp-\/>add\_scaled(v, x);}
\DoxyCodeLine{        tmp-\/>compute\_norm2(norm);}
\DoxyCodeLine{        \textcolor{keyword}{auto} res\_val = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{clone}}(exec-\/>get\_master(), norm)-\/>get\_values()[0];}
...
\DoxyCodeLine{        \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacegko_a99791881a0d56a1c5392ce52b4dce1ac}{abs}}(res\_val) < residual\_goal * \mbox{\hyperlink{namespacegko_a99791881a0d56a1c5392ce52b4dce1ac}{abs}}(g\_val)) \{}
\DoxyCodeLine{            \textcolor{keywordflow}{break};}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_inverse_iteration_Results}%
\doxysection*{Results}
...
\label{_inverse_iteration_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_inverse_iteration_PlainProg}%
