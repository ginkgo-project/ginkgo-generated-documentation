...
\DoxyCodeLine{        A-\/>apply(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(b), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(x));}
\DoxyCodeLine{    \}}
...
\DoxyCodeLine{A-\/>apply(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(b), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(xx));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{            x-\/>copy\_from(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(xx));}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} hp\_b = \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{share}}(hp\_vec::create(exec));}
...
\DoxyCodeLine{hp\_b-\/>copy\_from(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(host\_b));}
\DoxyCodeLine{lp\_b-\/>copy\_from(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(hp\_b));}
\end{DoxyCode}
...
\DoxyCodeLine{}
\DoxyCodeLine{    hp\_x-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(hp\_x\_norm));}
\DoxyCodeLine{    lp\_diff-\/>add\_scaled(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lp\_x));}
\DoxyCodeLine{    lp\_diff-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lp\_diff\_norm));}
\DoxyCodeLine{    hplp\_diff-\/>add\_scaled(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(hplp\_x));}
\DoxyCodeLine{    hplp\_diff-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(hplp\_diff\_norm));}
\DoxyCodeLine{    lplp\_diff-\/>add\_scaled(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lplp\_x));}
\DoxyCodeLine{    lplp\_diff-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lplp\_diff\_norm));}
\DoxyCodeLine{    lphp\_diff-\/>add\_scaled(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lphp\_x));}
\DoxyCodeLine{    lphp\_diff-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a4edc2273b5627ec552ea423b60493be3}{lend}}(lphp\_diff\_norm));}
\DoxyCodeLine{    exec-\/>synchronize();}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{High Precision time(s): 9.8980000000e-\/07}
\DoxyCodeLine{High Precision result norm: 2.5547848401e+05}
\DoxyCodeLine{Low Precision time(s): 9.8890000000e-\/07}
\DoxyCodeLine{Low Precision relative error: 5.5253439244e-\/08}
\DoxyCodeLine{Hp * Lp -\/> Hp time(s): 1.3829000000e-\/06}
\DoxyCodeLine{Hp * Lp -\/> Hp relative error: 1.6328092846e-\/08}
\DoxyCodeLine{Lp * Lp -\/> Hp time(s): 1.3761000000e-\/06}
\DoxyCodeLine{Lp * Lp -\/> Hp relative error: 2.5540873856e-\/08}
\DoxyCodeLine{Lp * Hp -\/> Hp time(s): 1.3761000000e-\/06}
\DoxyCodeLine{Lp * Hp -\/> Hp relative error: 3.7166469483e-\/08}
\end{DoxyCode}
