...
\item {\ttfamily -\/D\+G\+I\+N\+K\+G\+O\+\_\+\+E\+N\+A\+B\+L\+E\+\_\+\+H\+A\+LF=\{ON, O\+FF\}} enable half precision support in Ginkgo, default is {\ttfamily ON}. It is {\ttfamily O\+FF} when the compiler is M\+S\+VC.
