...
\DoxyCodeLine{    b-\/>compute\_norm2(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b\_norm));}
...
\DoxyCodeLine{    system\_matrix-\/>\mbox{\hyperlink{classgko_1_1LinOp_aff0379dbd0d86bd9ce2db03ac05f789f}{apply}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(neg\_one),}
\DoxyCodeLine{                         \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res));}
\DoxyCodeLine{    \textcolor{keywordflow}{return} compute\_norm(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res));}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{                                 \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a0913bfb81622f6bdde52884015c2a4ed}{gko::uintptr}}\&)\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{    }\{}
...
\DoxyCodeLine{                         \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a0913bfb81622f6bdde52884015c2a4ed}{gko::uintptr}}\&, \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a0913bfb81622f6bdde52884015c2a4ed}{gko::uintptr}}\&,}
\DoxyCodeLine{                         \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{gko::size\_type}}\&)\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{    }\{}
...
\DoxyCodeLine{                             \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a0913bfb81622f6bdde52884015c2a4ed}{gko::uintptr}}\& location)\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{}\{}
...
\DoxyCodeLine{                \mbox{\hyperlink{namespacegko_a618c9b64c35b0452240e9e57a9673b94}{gko::as}}<real\_vec<ValueType>>(residual\_norm)));}
\DoxyCodeLine{        \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{            rec\_res\_norms.push\_back(}
\DoxyCodeLine{                utils::compute\_norm(\mbox{\hyperlink{namespacegko_a618c9b64c35b0452240e9e57a9673b94}{gko::as}}<vec<ValueType>>(residual)));}
\DoxyCodeLine{        \}}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (solution) \{}
\DoxyCodeLine{            true\_res\_norms.push\_back(utils::compute\_residual\_norm(}
\DoxyCodeLine{                matrix, b, \mbox{\hyperlink{namespacegko_a618c9b64c35b0452240e9e57a9673b94}{gko::as}}<vec<ValueType>>(solution)));}
\DoxyCodeLine{        \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{            true\_res\_norms.push\_back(-\/1.0);}
\DoxyCodeLine{        \}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{}
\DoxyCodeLine{    ResidualLogger(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* matrix, \textcolor{keyword}{const} vec<ValueType>* b)}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} storage\_logger = std::make\_shared<loggers::StorageLogger>();}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}{add\_logger}}(storage\_logger);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(storage\_logger));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    solver\_factory-\/>generate(A)-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x\_clone));}
\DoxyCodeLine{    exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a24eeee7648c0f0fd07c9866d07154875}{synchronize}}();}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\DoxyCodeLine{generated\_solver-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x\_clone));}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a24eeee7648c0f0fd07c9866d07154875}{synchronize}}();}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    \textcolor{keyword}{auto} residual = utils::compute\_residual\_norm(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(A), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b),}
\DoxyCodeLine{                                                 \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x\_clone));}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} gen\_logger = std::make\_shared<loggers::OperationLogger>();}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}{add\_logger}}(gen\_logger);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(gen\_logger));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} apply\_logger = std::make\_shared<loggers::OperationLogger>();}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a520dad04b7e74f285ab0956873a5413d}{add\_logger}}(apply\_logger);}
\end{DoxyCode}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(A), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b));}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{generated\_solver-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x));}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(apply\_logger));}
\end{DoxyCode}
...
\DoxyCodeLine{print\_vector(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x));}
\end{DoxyCode}
...
\DoxyCodeLine{    cg::\mbox{\hyperlink{group__LinOp_ga2f54bac1e95fb3ef03974fa9c9088491}{initialize}}\#8: 872}
