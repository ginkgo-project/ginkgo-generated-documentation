...
\begin{DoxyCode}{0}
\DoxyCodeLine{b-\/>\mbox{\hyperlink{classgko_1_1matrix_1_1Dense_a97fd354c4a26814586cd256b5f0d7bea}{compute\_norm2}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b\_norm));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    \textcolor{keywordflow}{return} get\_first\_element(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b\_norm));}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{namespacegko_aa24837da3770b3dddf981d9bfe0d3b52}{write}}()\textcolor{keyword}{ const}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{std::cout << \textcolor{stringliteral}{"Recurrent vs true vs implicit residual norm:"}}
...
\DoxyCodeLine{          << \textcolor{stringliteral}{"True Residual Norm"} << \textcolor{charliteral}{'|'} << std::setw(25)}
\DoxyCodeLine{          << \textcolor{stringliteral}{"Implicit Residual Norm"} << \textcolor{charliteral}{'|'} << std::endl;}
\end{DoxyCode}
...
\DoxyCodeLine{          << std::setw(26) << \textcolor{charliteral}{'|'} << std::setfill(\textcolor{charliteral}{' '}) << std::endl;}
\end{DoxyCode}
...
\DoxyCodeLine{              << std::setw(25) << real\_norms[i] << \textcolor{charliteral}{'|'} << std::setw(25)}
\DoxyCodeLine{              << implicit\_norms[i] << \textcolor{charliteral}{'|'} << std::endl;}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} on\_iteration\_complete(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* solver,}
...
\DoxyCodeLine{\textcolor{keyword}{}\{}
\DoxyCodeLine{    this-\/>on\_iteration\_complete(solver, iteration, residual, solution,}
\DoxyCodeLine{                                residual\_norm, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} on\_iteration\_complete(}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}*, \textcolor{keyword}{const} \mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{gko::size\_type}}\& iteration,}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* residual, \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* solution,}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* residual\_norm,}
\DoxyCodeLine{    \textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* implicit\_sq\_residual\_norm)\textcolor{keyword}{ const override}}
\DoxyCodeLine{\textcolor{keyword}{}\{}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{recurrent\_norms.push\_back(get\_first\_element(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(dense\_norm)));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} norm = compute\_norm(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(dense\_residual));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{matrix-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(solution),}
\DoxyCodeLine{              \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    real\_norms.push\_back(compute\_norm(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res)));}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{if} (implicit\_sq\_residual\_norm) \{}
\DoxyCodeLine{    \textcolor{keyword}{auto} dense\_norm =}
\DoxyCodeLine{        gko::as<gko\_real\_dense>(implicit\_sq\_residual\_norm);}
\end{DoxyCode}


Add the norm to the {\ttfamily implicit\+\_\+norms} vector


\begin{DoxyCode}{0}
\DoxyCodeLine{    implicit\_norms.push\_back(}
\DoxyCodeLine{        std::sqrt(get\_first\_element(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(dense\_norm))));}
\DoxyCodeLine{\} \textcolor{keywordflow}{else} \{}
\end{DoxyCode}


Add to the {\ttfamily implicit\+\_\+norms} vector the value -\/1.\+0 if it could not be computed


\begin{DoxyCode}{0}
\DoxyCodeLine{    implicit\_norms.push\_back(-\/1.0);}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    ResidualLogger(\textcolor{keyword}{const} \mbox{\hyperlink{classgko_1_1LinOp}{gko::LinOp}}* matrix, \textcolor{keyword}{const} gko\_dense* b)}
\DoxyCodeLine{        : \mbox{\hyperlink{namespacegko}{gko}}::log::Logger(\mbox{\hyperlink{namespacegko}{gko}}::log::Logger::iteration\_complete\_mask),}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{mutable} std::vector<RealValueType> implicit\_norms\{\};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} logger =}
\DoxyCodeLine{    std::make\_shared<ResidualLogger<ValueType>>(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(A), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{solver-\/>\mbox{\hyperlink{classgko_1_1LinOp_a0449b2fc705d2f970855af23b5e2788e}{apply}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x));}
\end{DoxyCode}
...
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_aa24837da3770b3dddf981d9bfe0d3b52}{write}}(std::cout, \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x));}
\end{DoxyCode}
...
\DoxyCodeLine{    A-\/>apply(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(x), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(neg\_one), \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(b));}
\DoxyCodeLine{    b-\/>\mbox{\hyperlink{classgko_1_1matrix_1_1Dense_a97fd354c4a26814586cd256b5f0d7bea}{compute\_norm2}}(\mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res));}
\DoxyCodeLine{}
\DoxyCodeLine{    std::cout << \textcolor{stringliteral}{"Residual norm sqrt(r\string^T r):\(\backslash\)n"};}
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_aa24837da3770b3dddf981d9bfe0d3b52}{write}}(std::cout, \mbox{\hyperlink{namespacegko_a014ec51e675c425bb83908361f630450}{gko::lend}}(res));}
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_Results}%
\doxysection*{Results}
...
\DoxyCodeLine{Recurrent vs true vs implicit residual norm:}
\DoxyCodeLine{| Iteration|  Recurrent Residual Norm|       True Residual Norm|   Implicit Residual Norm|}
\DoxyCodeLine{|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|}
\DoxyCodeLine{|         0|             4.358899e+00|             4.358899e+00|             4.358899e+00|}
\DoxyCodeLine{|         1|             2.304548e+00|             2.304548e+00|             2.304548e+00|}
\DoxyCodeLine{|         2|             1.467706e+00|             1.467706e+00|             1.467706e+00|}
\DoxyCodeLine{|         3|             9.848751e-\/01|             9.848751e-\/01|             9.848751e-\/01|}
\DoxyCodeLine{|         4|             7.418330e-\/01|             7.418330e-\/01|             7.418330e-\/01|}
\DoxyCodeLine{|         5|             5.136231e-\/01|             5.136231e-\/01|             5.136231e-\/01|}
\DoxyCodeLine{|         6|             3.841650e-\/01|             3.841650e-\/01|             3.841650e-\/01|}
\DoxyCodeLine{|         7|             3.164394e-\/01|             3.164394e-\/01|             3.164394e-\/01|}
\DoxyCodeLine{|         8|             2.277088e-\/01|             2.277088e-\/01|             2.277088e-\/01|}
\DoxyCodeLine{|         9|             1.703121e-\/01|             1.703121e-\/01|             1.703121e-\/01|}
\DoxyCodeLine{|        10|             9.737220e-\/02|             9.737220e-\/02|             9.737220e-\/02|}
\DoxyCodeLine{|        11|             6.168306e-\/02|             6.168306e-\/02|             6.168306e-\/02|}
\DoxyCodeLine{|        12|             4.541231e-\/02|             4.541231e-\/02|             4.541231e-\/02|}
\DoxyCodeLine{|        13|             3.195304e-\/02|             3.195304e-\/02|             3.195304e-\/02|}
\DoxyCodeLine{|        14|             1.616058e-\/02|             1.616058e-\/02|             1.616058e-\/02|}
\DoxyCodeLine{|        15|             6.570152e-\/03|             6.570152e-\/03|             6.570152e-\/03|}
\DoxyCodeLine{|        16|             2.643669e-\/03|             2.643669e-\/03|             2.643669e-\/03|}
\DoxyCodeLine{|        17|             8.588089e-\/04|             8.588089e-\/04|             8.588089e-\/04|}
\DoxyCodeLine{|        18|             2.864613e-\/04|             2.864613e-\/04|             2.864613e-\/04|}
\DoxyCodeLine{|        19|             1.641952e-\/15|             2.107881e-\/15|             1.641952e-\/15|}
\DoxyCodeLine{|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/|}
