...
This example depends on simple-\/solver.
 ...
 \label{_minimal_cuda_solver_Intro}%
 \label{_minimal_cuda_solver_Introduction}%
...
\label{_minimal_cuda_solver_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_minimal_cuda_solver_CommProg}%
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_minimal_cuda_solver_Results}%
\doxysection*{Results}
...
\label{_minimal_cuda_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_minimal_cuda_solver_PlainProg}%
