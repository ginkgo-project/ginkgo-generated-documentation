...
This example depends on simple-\/solver.
 ...
 \label{_ilu_preconditioned_solver_Intro}%
 \label{_ilu_preconditioned_solver_Introduction}%
\doxysection*{Introduction}

\label{_ilu_preconditioned_solver_Abouttheexample}%
\doxysubsubsection*{About the example }

This example shows how to use incomplete factors generated via the Par\+I\+LU algorithm to generate an incomplete factorization (I\+LU) preconditioner, how to specify the sparse triangular solves in the I\+LU preconditioner application, and how to generate an I\+L\+U-\/preconditioned solver and apply it to a specific problem. \label{_ilu_preconditioned_solver_CommProg}%
...
\DoxyCodeLine{    \mbox{\hyperlink{classgko_1_1preconditioner_1_1Ilu}{gko::preconditioner::Ilu<ValueType, false, IndexType>::build}}().on(exec);}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_ilu_preconditioned_solver_Results}%
\doxysection*{Results}
...
\label{_ilu_preconditioned_solver_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_ilu_preconditioned_solver_PlainProg}%
