...
\DoxyCodeLine{done}
\end{DoxyCode}
\hypertarget{benchmarking_ginkgo_autotoc_md13}{}\doxysubsection{3\+: Running benchmarks manually}\label{benchmarking_ginkgo_autotoc_md13}
...
\item {\ttfamily D\+E\+T\+A\+I\+L\+ED=\{0,1\}} -\/ selects whether detailed benchmarks should be ran. This generally provides extra, verbose information at the cost of one or more extra benchmark runs. It can be either {\ttfamily 0} (off) or {\ttfamily 1} (on).
