...
This example depends on simple-\/solver.
 ...
 \label{_iterative_refinement_Intro}%
 \label{_iterative_refinement_Thisexampleshowshowtousetheiterativerefinementsolver}%
...
\label{_iterative_refinement_CommProg}%
...
\DoxyCodeLine{\textcolor{keyword}{auto} host\_x = \mbox{\hyperlink{classgko_1_1matrix_1_1Dense_a04562b9cf07b14ec1ef4865a3fe8e7fa}{gko::matrix::Dense<ValueType>::create}}(exec-\/>get\_master(),}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespacegko_a6e5c95df0ae4e47aab2f604a22d98ee7}{gko::size\_type}} \mbox{\hyperlink{namespacegko_1_1stop_afcbdb7495467cfc7e059209e53144989}{max\_iters}} = 10000u;}
\DoxyCodeLine{RealValueType outer\_reduction\_factor\{1e-\/12\};}
\DoxyCodeLine{RealValueType inner\_reduction\_factor\{1e-\/2\};}
\DoxyCodeLine{\textcolor{keyword}{auto} solver\_gen =}
\DoxyCodeLine{    ir::build()}
\DoxyCodeLine{        .with\_solver(cg::build().with\_criteria(}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_iterative_refinement_Results}%
\doxysection*{Results}
...
\DoxyCodeLine{IR execution time [ms]: 0.794962}
\end{DoxyCode}


\label{_iterative_refinement_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_iterative_refinement_PlainProg}%
