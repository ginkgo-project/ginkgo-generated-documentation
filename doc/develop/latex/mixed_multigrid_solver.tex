...
\DoxyCodeLine{\textcolor{keyword}{using} pgm2 = \mbox{\hyperlink{classgko_1_1multigrid_1_1Pgm}{gko::multigrid::Pgm<ValueType2, IndexType>}};}
\end{DoxyCode}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespacegko_a3ce296f73db0ff398bdea6009a3a5c58}{gko::share}}(pgm2::build().with\_deterministic(\textcolor{keyword}{true}).on(exec));}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} level0 = gko::as<pgm>(mg\_level\_list.at(0));}
\DoxyCodeLine{\textcolor{keyword}{auto} level1 = gko::as<pgm2>(mg\_level\_list.at(1));}
