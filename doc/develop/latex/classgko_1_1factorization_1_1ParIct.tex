...
Inheritance diagram for gko\+::factorization\+::Par\+Ict$<$ Value\+Type, Index\+Type $>$\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classgko_1_1factorization_1_1ParIct__inherit__graph}
\end{center}
\end{figure}
...
\begin{DoxyEnumerate}
\item Calculate the residual $R = A - LL^T$.
\item Add new non-\/zero locations from $R$ to $L$. The new non-\/zero locations are initialized from the corresponding residual entries.
\item Execute a fixed-\/point iteration on $L$ according to

\[ F(L)_{ij} = \begin{cases} \frac{1}{l_{jj}} \left( a_{ij} - \sum_{k=1}^{j-1} l_{ik} l_{jk} \right), & i \neq j, \\ \sqrt{ a_{ij} - \sum_{k=1}^{j-1} l_{ik} l_{jk} }, & i = j. \end{cases} \]
\item Remove the smallest entries (by magnitude) from $L$.
\item Execute a fixed-\/point iteration on the (now sparser) $L$.
\end{DoxyEnumerate}
...
\mbox{\Hypertarget{classgko_1_1factorization_1_1ParIct_ad53fcd00345d5d4cf5558acc8e99970b}\label{classgko_1_1factorization_1_1ParIct_ad53fcd00345d5d4cf5558acc8e99970b}} 
\index{gko::factorization::ParIct$<$ ValueType, IndexType $>$@{gko::factorization::ParIct$<$ ValueType, IndexType $>$}!parse@{parse}}
\index{parse@{parse}!gko::factorization::ParIct$<$ ValueType, IndexType $>$@{gko::factorization::ParIct$<$ ValueType, IndexType $>$}}
\doxysubsubsection{\texorpdfstring{parse()}{parse()}}
{\footnotesize\ttfamily template$<$typename Value\+Type  = default\+\_\+precision, typename Index\+Type  = int32$>$ \\
static \mbox{\hyperlink{structgko_1_1factorization_1_1ParIct_1_1parameters__type}{parameters\+\_\+type}} \mbox{\hyperlink{classgko_1_1factorization_1_1ParIct}{gko\+::factorization\+::\+Par\+Ict}}$<$ Value\+Type, Index\+Type $>$\+::parse (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classgko_1_1config_1_1pnode}{config\+::pnode}} \&}]{config,  }\item[{const \mbox{\hyperlink{classgko_1_1config_1_1registry}{config\+::registry}} \&}]{context,  }\item[{const \mbox{\hyperlink{classgko_1_1config_1_1type__descriptor}{config\+::type\+\_\+descriptor}} \&}]{td\+\_\+for\+\_\+child = {\ttfamily config\+:\+:make\+\_\+type\+\_\+descriptor$<$~ValueType,~IndexType~$>$()} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
