The ranges and accessor example..
 ...
 \label{_ginkgo_ranges_Intro}%
 \label{_ginkgo_ranges_Introduction}%
\doxysection*{Introduction}

\label{_ginkgo_ranges_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_ginkgo_ranges_CommProg}%
...
\label{_ginkgo_ranges_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_ginkgo_ranges_PlainProg}%
