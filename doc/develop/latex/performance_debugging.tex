...
This example depends on simple-\/solver-\/logging, minimal-\/cuda-\/solver.
 ...
 \label{_performance_debugging_Intro}%
 \label{_performance_debugging_Introduction}%
\doxysection*{Introduction}

\label{_performance_debugging_Abouttheexample}%
\doxysubsubsection*{About the example }

This example runs a solver on a test problem and shows how to use loggers to debug performance and convergence rate. \label{_performance_debugging_CommProg}%
...
\DoxyCodeLine{    b-\/>compute\_norm2(b\_norm);}
...
\DoxyCodeLine{    \textcolor{keyword}{auto} res = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(b);}
\DoxyCodeLine{    system\_matrix-\/>\mbox{\hyperlink{classgko_1_1LinOp_af9979dfd1401bd219b02caaaa445b893}{apply}}(one, x, neg\_one, res);}
\DoxyCodeLine{    \textcolor{keywordflow}{return} compute\_norm(res.get());}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(storage\_logger);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keyword}{auto} \mbox{\hyperlink{namespacegko_1_1stop_afcbdb7495467cfc7e059209e53144989}{max\_iters}} = A-\/>get\_size()[0];}
\end{DoxyCode}
...
\DoxyCodeLine{            gko::stop::Iteration::build().with\_max\_iters(max\_iters))}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} x\_clone = \mbox{\hyperlink{namespacegko_adc9a73d088d88d5dfdaf63aff9e96012}{gko::clone}}(x);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{    solver\_factory-\/>generate(A)-\/>apply(b, x\_clone);}
\DoxyCodeLine{    exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a24eeee7648c0f0fd07c9866d07154875}{synchronize}}();}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\DoxyCodeLine{generated\_solver-\/>apply(b, x\_clone);}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_a24eeee7648c0f0fd07c9866d07154875}{synchronize}}();}
...
\DoxyCodeLine{        utils::compute\_residual\_norm(A.get(), b.get(), x\_clone.get());}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(gen\_logger);}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{generated\_solver-\/>apply(b, x);}
\DoxyCodeLine{exec-\/>\mbox{\hyperlink{classgko_1_1Executor_af04cdc1a9af6c8efc34ddebb9e7aaf00}{remove\_logger}}(apply\_logger);}
\end{DoxyCode}
...
\DoxyCodeLine{print\_vector(x.get());}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
 \label{_performance_debugging_Results}%
\doxysection*{Results}
...
\label{_performance_debugging_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_performance_debugging_PlainProg}%
