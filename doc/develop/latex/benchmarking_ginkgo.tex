...
\end{DoxyEnumerate}\hypertarget{benchmarking_ginkgo_autotoc_md13}{}\doxysubsection{1\+: Ginkgo setup and best practice guidelines}\label{benchmarking_ginkgo_autotoc_md13}
...
\end{DoxyEnumerate}\hypertarget{benchmarking_ginkgo_autotoc_md14}{}\doxysubsection{2\+: Using ssget to fetch the matrices}\label{benchmarking_ginkgo_autotoc_md14}
...
\DoxyCodeLine{done}
\end{DoxyCode}
\hypertarget{benchmarking_ginkgo_autotoc_md15}{}\doxysubsection{3\+: Benchmarking overview}\label{benchmarking_ginkgo_autotoc_md15}
...
\end{DoxyItemize}\hypertarget{benchmarking_ginkgo_autotoc_md16}{}\doxysubsection{4\+: Publishing the results on Github and analyze the results with the G\+P\+E (optional)}\label{benchmarking_ginkgo_autotoc_md16}
...
\end{DoxyEnumerate}\hypertarget{benchmarking_ginkgo_autotoc_md17}{}\doxysubsection{5\+: Detailed performance analysis and debugging}\label{benchmarking_ginkgo_autotoc_md17}
...
These features are implemented thanks to the loggers located in the file {\ttfamily \$\{ginkgo\+\_\+src\+\_\+dir\}/benchmark/utils/loggers.hpp}. Ginkgo possesses hooks at all important code location points which can be inspected thanks to the logger. In this fashion, it is easy to use these loggers also for tracking memory allocation sizes and other important library aspects.\hypertarget{benchmarking_ginkgo_autotoc_md18}{}\doxysubsection{6\+: Available benchmark options}\label{benchmarking_ginkgo_autotoc_md18}
