...
This example depends on simple-\/solver-\/logging.
 ...
 \label{_papi_logging_Intro}%
 \label{_papi_logging_Introduction}%
\doxysection*{Introduction}

\label{_papi_logging_Abouttheexample}%
\doxysubsubsection*{About the example }

\label{_papi_logging_CommProg}%
...
\label{_papi_logging_Commentsaboutprogramminganddebugging}%
\doxysubsubsection*{Comments about programming and debugging }

\label{_papi_logging_PlainProg}%
