...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classgko_1_1batch_1_1preconditioner_1_1Jacobi_a5c86b049c857401eadafc2b05ee11aef}\label{classgko_1_1batch_1_1preconditioner_1_1Jacobi_a5c86b049c857401eadafc2b05ee11aef}} 
...
Element $(i, j)$ of the block that belongs to batch entry {\ttfamily batch\+\_\+id} and has local id {\ttfamily block\+\_\+id} within that entry is stored at the address


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classgko_1_1batch_1_1preconditioner_1_1Jacobi_a3e017b255c359e618ae52f65840dbcc0}{get\_const\_blocks}}()}
\DoxyCodeLine{    + detail::get\_global\_block\_offset(batch\_id, num\_blocks, block\_id,}
\DoxyCodeLine{                                      cumulative\_blocks\_storage)}
\DoxyCodeLine{    + i * detail::get\_stride(block\_id, block\_pointers)}
\DoxyCodeLine{    + j}
\end{DoxyCode}
